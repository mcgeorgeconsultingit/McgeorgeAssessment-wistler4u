            ...
            for line in move.invoice_line_ids:
                ...
                if line.product_id.cost_method != "standard" and line.purchase_line_id:
                    ...
                    (
                        ...
                        valuation_total_qty,
                    ) = valuation_stock_moves._get_valuation_price_and_qty(line, move.currency_id)
                    ...
                    price_unit = (
                        -price_unit if line.move_id.move_type == "in_refund" else price_unit
                    )
                    valuation_date = (
                        valuation_stock_moves
                    ...
                    valuation_price_unit = line.company_currency_id._convert(
                        price_unit, move.currency_id, move.company_id, valuation_date, round=False
                    )
                ...
                if (
                    ...
                    and float_compare(
                        line["price_unit"], line.price_unit, precision_digits=price_unit_prec
                    )
                    == 0
                ):
