...
class SaleOrderLine(models.Model):
    ...
    def _update_registrations(
        self, confirm=True, cancel_to_draft=False, registration_data=None, mark_as_paid=False
    ):
        ...
        for so_line in self:
            ...
            for count in range(int(so_line.product_uom_qty) - len(existing_registrations)):
                values = {"sale_order_line_id": so_line.id, "sale_order_id": so_line.order_id.id}
