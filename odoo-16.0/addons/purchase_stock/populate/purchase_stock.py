...
class PurchaseOrder(models.Model):
    ...
    def _populate_factories(self):
        ...
        picking_types_by_company = {
            com: self.env["stock.picking.type"].concat(*pt) | picking_types_inter_company
            for com, pt in picking_types_by_company.items()
            if com
        }
        ...
        return res + [("picking_type_id", populate.compute(get_picking_type_id))]
