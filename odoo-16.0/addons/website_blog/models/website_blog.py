...
class BlogPost(models.Model):
    ...
    author_name = fields.Char(
        related="author_id.display_name", string="Author Name", readonly=False, store=True
    )
    active = fields.Boolean("Active", default=True)
    ...
    def write(self, vals):
        ...
        for post in self:
            ...
            if (
                ...
                and (not post.published_date or post.published_date <= fields.Datetime.now())
            ):
    ...
    def _default_website_meta(self):
        ...
        res["default_opengraph"]["og:image"] = res["default_twitter"]["twitter:image"] = (
