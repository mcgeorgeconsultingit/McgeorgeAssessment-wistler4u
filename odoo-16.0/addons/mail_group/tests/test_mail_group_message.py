...
class TestMailGroupMessage(TestMailListCommon):
    def test_batch_send(self):
        ...
        self.assertEqual(
            message.subject, "Never Surrender", "Should have created a <mail.group.message>"
        )
    ...
    def test_email_duplicated(self):
        ...
        self.assertEqual(
            message.subject, "Test subject", "Should have created a <mail.group.message>"
        )
    ...
    def test_mail_group_message_security_groups(self):
        ...
        self.assertEqual(
            self.test_group_msg_1_pending.with_user(self.user_employee).moderation_status,
            "pending_moderation",
        ...
        self.assertEqual(
            self.test_group_msg_2_accepted.with_user(self.user_portal).moderation_status,
            "accepted",
        ...
        self.user_portal.groups_id -= user_group
        with self.assertRaises(
            AccessError, msg="User not in the group should not have access to accepted message"
        ):
