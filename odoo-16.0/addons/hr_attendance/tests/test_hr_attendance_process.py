...
class TestHrAttendance(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.user = new_test_user(
            cls.env, login="fru", groups="base.group_user,hr_attendance.group_hr_attendance_use_pin"
        )
    ...
    def test_checkin_self_without_pin(self):
        ...
        self.assertEqual(
            employee.attendance_state, "checked_in", "He should be able to check in without pin"
        )
        employee.attendance_manual({}, entered_pin=None)
        self.assertEqual(
            employee.attendance_state, "checked_out", "He should be able to check out without pin"
        )
    ...
    def test_checkin_self_with_pin(self):
        ...
        self.assertEqual(
            employee.attendance_state, "checked_in", "He should be able to check in with his pin"
        )
        employee.attendance_manual({}, entered_pin="1234")
        self.assertEqual(
            employee.attendance_state, "checked_out", "He should be able to check out with his pin"
        )
    ...
    def test_checkin_kiosk_without_pin(self):
        ...
        self.assertNotEqual(
            employee.attendance_state, "checked_in", "He should not be able to check in with no pin"
        )
        self.assertTrue(action.get("warning"))
    ...
    def test_checkin_kiosk_no_pin_mode(self):
        ...
        employee.attendance_manual({}, entered_pin=None)
        self.assertEqual(
            employee.attendance_state, "checked_out", "He shouldn't be able to check in without"
        )
