...
class WebsiteHrRecruitment(http.Controller):
    ...
    def jobs(self, country=None, department=None, office_id=None, contract_type_id=None, **kwargs):
        ...
        if not (
            country or department or office_id or contract_type_id or kwargs.get("all_countries")
        ):
        ...
        if contract_type_id:
            jobs = [
                j for j in jobs if j.contract_type_id and j.contract_type_id.id == contract_type_id
            ]
