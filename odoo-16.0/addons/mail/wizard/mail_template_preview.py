...
class MailTemplatePreview(models.TransientModel):
    ...
    email_to = fields.Char(
        "To", compute="_compute_mail_template_fields", help="Comma-separated recipient addresses"
    )
    email_cc = fields.Char(
        "Cc", compute="_compute_mail_template_fields", help="Carbon copy recipients"
    )
    reply_to = fields.Char(
        "Reply-To", compute="_compute_mail_template_fields", help="Preferred response address"
    )
