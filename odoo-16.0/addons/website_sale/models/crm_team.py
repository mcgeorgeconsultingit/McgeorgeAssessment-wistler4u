...
class CrmTeam(models.Model):
    ...
    abandoned_carts_count = fields.Integer(
        compute="_compute_abandoned_carts", string="Number of Abandoned Carts", readonly=True
    )
    abandoned_carts_amount = fields.Integer(
        compute="_compute_abandoned_carts", string="Amount of Abandoned Carts", readonly=True
    )
