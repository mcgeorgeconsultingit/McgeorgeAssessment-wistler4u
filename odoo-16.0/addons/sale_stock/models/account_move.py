...
class AccountMove(models.Model):
    ...
    def _stock_account_get_last_step_stock_moves(self):
        ...
        for invoice in self.filtered(lambda x: x.move_type == "out_refund"):
            ...
            ).filtered(lambda x: x.state == "done" and x.location_id.usage == "customer")
    ...
    def _get_invoiced_lot_values(self):
        ...
        for sml in stock_move_lines:
            ...
            is_stock_return = (
                ...
                and (sml.location_id.usage, sml.location_dest_id.usage) == ("customer", "internal")
                or self.move_type == "out_refund"
                and (sml.location_id.usage, sml.location_dest_id.usage) == ("internal", "customer")
            )
            if is_stock_return:
        ...
        for lot, qty in qties_per_lot.items():
            ...
            if (
                float_is_zero(
                    invoiced_qties[lot.product_id], precision_rounding=lot.product_uom_id.rounding
                )
    ...
    def _stock_account_get_anglo_saxon_price_unit(self):
        ...
        if so_line:
            ...
            average_price_unit = product._compute_average_price(
                qty_invoiced, qty_to_invoice, so_line.move_ids, is_returned=is_line_reversing
            )
