...
class HrEmployee(models.Model):
    ...
    def _compute_presence_state(self):
        ...
        employee_to_check_working = self.filtered(
            lambda e: e.attendance_state == "checked_out" and e.hr_presence_state == "to_define"
        )
    ...
    @api.depends(
        "last_attendance_id.check_in", "last_attendance_id.check_out", "last_attendance_id"
    )
    ...
    def attendance_manual(self, next_action, entered_pin=None):
        ...
        attendance_user_and_no_pin = self.user_has_groups(
            "hr_attendance.group_hr_attendance_user," "!hr_attendance.group_hr_attendance_use_pin"
        )
