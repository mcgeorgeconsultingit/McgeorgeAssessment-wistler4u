...
class TestComputeRankCommon(common.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        patch_email = patch(
            "odoo.addons.mail.models.mail_template.MailTemplate.send_mail", _patched_send_mail
        )
        ...
        self.assertEqual(
            ...
            len(
                [
                    u
                    for u in self.users
                    if u.karma >= self.rank_1.karma_min and u.karma < self.rank_2.karma_min
                ]
            ),
        )
        self.assertEqual(
            ...
            len(
                [
                    u
                    for u in self.users
                    if u.karma >= self.rank_2.karma_min and u.karma < self.rank_3.karma_min
                ]
            ),
        )
        self.assertEqual(
            ...
            len(
                [
                    u
                    for u in self.users
                    if u.karma >= self.rank_3.karma_min and u.karma < self.rank_4.karma_min
                ]
            ),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            len(
                [
                    u
                    for u in self.users
                    if u.karma >= self.rank_1.karma_min and u.karma < self.rank_3.karma_min
                ]
            ),
        )
        self.assertEqual(
            ...
            len(
                [
                    u
                    for u in self.users
                    if u.karma >= self.rank_3.karma_min and u.karma < self.rank_2.karma_min
                ]
            ),
        )
        self.assertEqual(
            ...
            len(
                [
                    u
                    for u in self.users
                    if u.karma >= self.rank_2.karma_min and u.karma < self.rank_4.karma_min
                ]
            ),
        )
        self.assertEqual(
    ...
    def test_02_update_rank_without_switch(self):
        ...
        self.assertEqual(
            number_of_users, 7, "Should just recompute for the 7 users between 500 and 700"
        )
