            ...
            [
                {
                    ...
                    "value_ids": [
                        (6, 0, [cls.product_attribute_value_1.id, cls.product_attribute_value_2.id])
                    ],
                }
            ]
        )
            ...
            [
                {
                    ...
                    "product_tmpl_id": cls.product_template.id,
                    "value_ids": [
                        (6, 0, [cls.product_attribute_value_3.id, cls.product_attribute_value_4.id])
                    ],
                }
            ]
        )
        ...
        ptav1.update(
            {
                "exclude_for": [
                    (
                        0,
                        0,
                        {"product_tmpl_id": product_template.id, "value_ids": [(6, 0, [ptav2.id])]},
                    )
                ]
            }
        )
