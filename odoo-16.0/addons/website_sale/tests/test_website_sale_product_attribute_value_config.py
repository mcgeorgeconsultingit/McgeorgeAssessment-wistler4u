...
class TestWebsiteSaleProductAttributeValueConfig(
    ...
    def test_get_combination_info(self):
        ...
        self.assertEqual(
            combination_info["list_price"], 2222 * discount_rate * currency_ratio * tax_ratio
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            pricelist.currency_id.round(2222 * discount_rate * currency_ratio * tax_ratio),
            0,
        )
        self.assertEqual(
    ...
    def test_get_combination_info_with_fpos(self):
        ...
        self.assertEqual(
            combination_info["price_extra"], 200, "200% + 0% tax (mapped from fp 15% -> 0%)"
        )
        ...
        self.assertEqual(
            combination_info["price_extra"], 173.91, "173.91$ + 0% tax (mapped from fp 15% -> 0%)"
        )
