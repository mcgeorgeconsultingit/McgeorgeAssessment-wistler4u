...
class ProductCommon(
    ...
    def setUpClass(cls):
        ...
        NO_TAXES_CONTEXT = {"default_taxes_id": False}
    ...
    def _archive_other_pricelists(cls):
        ...
        if website_sale.state == "installed":
            archive_context = patch(
                "odoo.addons.website_sale.models.product_pricelist.ProductPricelist._check_website_pricelist"
            )
        else:
