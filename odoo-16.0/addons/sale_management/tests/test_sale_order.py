...
class TestSaleOrder(SaleManagementCommon):
    ...
    def test_01_template_without_pricelist(self):
        ...
        self.assertEqual(
            ...
            self.product_1.id,
            "The sale order shall contains the same products as the" "quotation template.",
        )

        self.assertEqual(
            self.sale_order.order_line[0].price_unit,
            self.pub_product_price,
            "Without any price list and discount, the public price of" "the product shall be used.",
        )
        ...
        self.assertEqual(
            ...
            "The sale order shall contains the same optional products as the" "quotation template.",
        )
    ...
    def test_02_template_with_discount_included_pricelist(self):
        ...
        self.assertEqual(
            ...
            "If a pricelist is set, the product price shall be computed" "according to it.",
        )
