...
class TestHrAttendanceOvertime(TransactionCase):
    ...
    def test_overtime_unclosed(self):
        ...
        self.assertEqual(
            overtime.duration, 0, "Overtime entry has been reset due to an unclosed attendance."
        )
    ...
    def test_overtime_company_threshold(self):
        ...
        self.assertTrue(
            overtime, "Overtime entry should exist since the threshold has been lowered."
        )
    ...
    def test_overtime_both_threshold(self):
        ...
        self.assertTrue(
            overtime, "Overtime entry should exist since the employee threshold has been lowered."
        )
        self.assertAlmostEqual(
        ...
        self.assertFalse(
            overtime, "Overtime entry should be unlinked since both overtime cancel each other."
        )
