...
class TestSMSActionsCommon(TestSMSCommon, TestSMSRecipients):
    ...
    def test_search_phone_mobile_search_equal(self):
        ...
        self.assertFalse(
            results, "Search on phone_mobile_search: = should return only matching results"
        )
    ...
    def test_search_phone_mobile_search_ilike(self):
        ...
        self.assertEqual(
            results, test_phone_records[5:8], "Search on phone_mobile_search: +32/0032 likeliness"
        )
