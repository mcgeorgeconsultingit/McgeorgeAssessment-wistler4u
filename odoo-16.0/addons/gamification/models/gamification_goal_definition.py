...
class GoalDefinition(models.Model):
    ...
    full_suffix = fields.Char(
        "Full Suffix", compute="_compute_full_suffix", help="The currency and suffix field"
    )
    ...
    batch_mode = fields.Boolean(
        "Batch Mode", help="Evaluate the expression in batch instead of once for each user"
    )
