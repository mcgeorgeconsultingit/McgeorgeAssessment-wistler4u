...
class ResCompany(models.Model):
    ...
    l10n_it_eco_index_sole_shareholder = fields.Selection(
        [("NO", "Not a limited liability company"), ("SU", "Socio unico"), ("SM", "Più soci")],
        string="Shareholder",
    )
    ...
    def _check_eco_incorporated(self):
        ...
        for record in self:
            if record.l10n_it_has_eco_index and bool(record.l10n_it_eco_index_share_capital) ^ bool(
    ...
    @api.constrains("l10n_it_has_tax_representative", "l10n_it_tax_representative_partner_id")
