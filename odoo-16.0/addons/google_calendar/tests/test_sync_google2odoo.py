...
class TestSyncGoogle2Odoo(TestSyncGoogle):
    ...
    def test_new_google_event(self):
        values = {
            ...
            "start": {"dateTime": "2020-01-13T16:55:00+01:00", "timeZone": "Europe/Brussels"},
            "end": {"dateTime": "2020-01-13T19:55:00+01:00", "timeZone": "Europe/Brussels"},
        }
    ...
    def test_valid_owner_property(self):
        ...
        values = {
            ...
            "reminders": {"useDefault": True},
            "start": {"dateTime": "2020-01-13T16:55:00+01:00", "timeZone": "Europe/Brussels"},
            "extendedProperties": {"shared": {"%s_owner_id" % self.env.cr.dbname: str(user.id)}},
            "end": {"dateTime": "2020-01-13T19:55:00+01:00", "timeZone": "Europe/Brussels"},
        }
        self.env["calendar.event"]._sync_google2odoo(GoogleEvent([values]))
        event = self.env["calendar.event"].search([("google_id", "=", values.get("id"))])
    ...
    def test_new_google_notifications(self):
        ...
        values = {
            ...
            "end": {"dateTime": pytz.utc.localize(end).isoformat(), "timeZone": "Europe/Brussels"},
        }
        self.env["calendar.event"]._sync_google2odoo(GoogleEvent([values]))
    ...
    def test_attendee_recurrence_answer(self):
        ...
        self.assertEqual(
            attendee, ["declined", "declined", "declined"], "All events should be declined"
        )
        self.assertGoogleAPINotCalled()
            ...
            [
                {
                    ...
                    "end": {"dateTime": "2020-01-13T20:00:00+01:00", "timeZone": "Europe/Brussels"},
                }
            ]
        )
        self.sync(gevent)
    ...
    def test_several_users_have_the_same_mail(self):
        ...
        values = {
            ...
            "reminders": {"useDefault": True},
            "start": {"dateTime": "2020-01-13T16:00:00+01:00", "timeZone": "Europe/Brussels"},
            "end": {"dateTime": "2020-01-13T20:00:00+01:00", "timeZone": "Europe/Brussels"},
        }
