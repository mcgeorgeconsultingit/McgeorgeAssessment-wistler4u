...
class TestCertificationFlow(common.TestSurveyCommon, HttpCase):
    def test_flow_certification(self):
        ...
        self.assertResponse(
            response, 200, [certification.title, "Time limit for this certification", "10 minutes"]
        )
        ...
        self.assertNotIn(
            "I think they're great!", user_inputs.mapped("user_input_line_ids.value_text_box")
        )
        self.assertIn(
    ...
    def test_randomized_certification(self):
        ...
        with patch.object(IrMailServer, "connect"):
            ...
            self._answer_question(
                question_ids, question_ids.suggested_answer_ids.ids[0], answer_token, csrf_token
            )
