...
class TestAccrualAllocations(TestHrHolidaysCommon):
    ...
    def test_frequency_daily(self):
        with freeze_time(datetime.date(2017, 12, 5)):
            ...
            self.assertFalse(
                allocation.nextcall, "There should be no nextcall set on the allocation."
            )
            ...
            with freeze_time(tomorrow):
                ...
                allocation._update_accrual()
                self.assertEqual(
                    allocation.number_of_days, 1, "There should be only 1 day allocated."
                )
        ...
        with freeze_time(datetime.date(2017, 12, 5)):
            ...
            with freeze_time(nextWeek):
                ...
                self.assertAlmostEqual(
                    allocation.number_of_days, 0.2857, 4, "There should be 0.2857 day allocated."
                )
                self.assertEqual(
                    allocation.nextcall,
                    nextWeek,
            ...
            with freeze_time(nextWeek):
                ...
                nextWeek = datetime.date.today() + relativedelta(days=1, weekday=0)
                self.assertAlmostEqual(
                    allocation.number_of_days, 1.2857, 4, "There should be 1.2857 day allocated."
                )
                self.assertEqual(
                    allocation.nextcall,
                    nextWeek,
    ...
    def test_frequency_bimonthly(self):
        ...
        with freeze_time(next_date):
            ...
            # Prorated
            self.assertAlmostEqual(
                allocation.number_of_days, 0.7857, 4, "There should be 0.7857 day allocated."
            )
            self.assertEqual(
                allocation.nextcall,
                next_date,
        ...
        with freeze_time(next_date):
            ...
            # Not Prorated
            self.assertAlmostEqual(
                allocation.number_of_days, 1.7857, 4, "There should be 1.7857 day allocated."
            )
    ...
    def test_frequency_biyearly(self):
        ...
        with freeze_time(next_date):
            ...
            # Prorated
            self.assertAlmostEqual(
                allocation.number_of_days, 0.6576, 4, "There should be 0.6576 day allocated."
            )
            self.assertEqual(
                allocation.nextcall, next_date, "The next call date of the cron should be July 1st"
            )
        ...
        with freeze_time(next_date):
            ...
            # Not Prorated
            self.assertAlmostEqual(
                allocation.number_of_days, 1.6576, 4, "There should be 1.6576 day allocated."
            )
    ...
    def test_frequency_yearly(self):
        ...
        with freeze_time(next_date):
            ...
            allocation._update_accrual()
            self.assertAlmostEqual(
                allocation.number_of_days, 0.3315, 4, "There should be 0.3315 day allocated."
            )
            self.assertEqual(
                allocation.nextcall,
                next_date,
        ...
        with freeze_time(next_date):
            allocation._update_accrual()
            self.assertAlmostEqual(
                allocation.number_of_days, 1.3315, 4, "There should be 1.3315 day allocated."
            )
    ...
    def test_check_gain(self):
        ...
        with freeze_time("2021-08-30"):
            ...
            self.assertEqual(
                allocation_worked_time.number_of_days, 0, "There should be no days allocated yet."
            )
        ...
        with freeze_time(next_date):
            ...
            # Prorated
            self.assertAlmostEqual(
                allocation_worked_time.number_of_days, 3, 4, "There should be 3 days allocated."
            )
            self.assertEqual(
                allocation_not_worked_time.nextcall,
        ...
        with freeze_time(next_date + relativedelta(days=7)):
            ...
            self.assertAlmostEqual(
                allocation_worked_time.number_of_days, 8, 4, "There should be 8 days allocated."
            )
            self.assertEqual(
                allocation_worked_time.nextcall,
                next_date,
    ...
    def test_check_max_value_hours(self):
        with freeze_time(datetime.date(2017, 12, 5)):
            ...
            with freeze_time(tomorrow):
                ...
                allocation._update_accrual()
                self.assertEqual(
                    allocation.number_of_days, 0.125, "There should be only 0.125 days allocated."
                )
            ...
            with freeze_time(nextcall):
                ...
                allocation._update_accrual()
                self.assertEqual(
                    allocation.number_of_days, 0.5, "There should be only 0.5 days allocated."
                )
    ...
    def test_unused_accrual_lost(self):
        ...
        accrual_cron = (
            self.env["ir.cron"].sudo().env.ref("hr_holidays.hr_leave_allocation_cron_accrual")
        )
    ...
    def test_unused_accrual_postponed(self):
        ...
        with freeze_time("2022-01-01"):
            allocation._update_accrual()
        self.assertEqual(
            allocation.number_of_days, 25, "The maximum number of days should be reached and kept."
        )
        ...
        with freeze_time("2023-01-26"):
            allocation._update_accrual()
        self.assertEqual(
            allocation.number_of_days, 6, "The maximum number of days should be reached and kept."
        )
    ...
    def test_unused_accrual_postponed_limit(self):
        ...
        with freeze_time("2022-01-01"):
            allocation._update_accrual()
        self.assertEqual(
            allocation.number_of_days, 16, "The maximum number of days should be reached and kept."
        )
        ...
        with freeze_time("2023-01-26"):
            allocation._update_accrual()
        self.assertEqual(
            allocation.number_of_days, 22, "The maximum number of days should be reached and kept."
        )
