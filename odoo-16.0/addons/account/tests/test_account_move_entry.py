...
class TestAccountMove(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        tax_repartition_line = cls.company_data[
            "default_tax_sale"
        ].refund_repartition_line_ids.filtered(lambda line: line.repartition_type == "tax")
    ...
    def test_misc_fiscalyear_lock_date_1(self):
        ...
        self.assertEqual(
            copy_move.date, copy_move.company_id.fiscalyear_lock_date + relativedelta(days=1)
        )
