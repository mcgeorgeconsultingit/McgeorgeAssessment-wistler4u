...
class MailingSMSController(http.Controller):
    ...
    @http.route(
        ["/sms/<int:mailing_id>/<string:trace_code>"], type="http", website=True, auth="public"
    )
    ...
    def blacklist_number(self, mailing_id, trace_code, **post):
        ...
        sanitize_res = phone_validation.phone_sanitize_numbers([sms_number], country_code, None)[
            sms_number
        ]
