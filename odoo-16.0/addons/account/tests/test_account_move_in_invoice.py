...
class TestAccountMoveInInvoiceOnchanges(AccountTestInvoicingCommon):
    ...
    def test_fiduciary_mode_date_suggestion(self):
        ...
        self.init_invoice(
            move_type="in_invoice", invoice_date="2022-03-15", products=self.product_a, post=True
        )
        move_form = Form(self.env["account.move"].with_context(default_move_type="in_invoice"))
        ...
        self.init_invoice(
            move_type="in_invoice", invoice_date="2022-03-31", products=self.product_b, post=True
        )
        move_form = Form(self.env["account.move"].with_context(default_move_type="in_invoice"))
        self.assertEqual(move_form.invoice_date.strftime("%Y-%m-%d"), "2022-03-31")
        ...
        move = self.init_invoice(
            move_type="in_invoice", invoice_date="2022-06-16", products=self.product_b, post=True
        )
        move_form = Form(self.env["account.move"].with_context(default_move_type="in_invoice"))
        ...
        move = self.init_invoice(
            move_type="in_invoice", invoice_date="2022-04-30", products=self.product_a, post=True
        )
        ...
        self.init_invoice(
            move_type="in_invoice", invoice_date="2022-05-01", products=self.product_b, post=True
        )
        move_form = Form(self.env["account.move"].with_context(default_move_type="in_invoice"))
        self.assertEqual(move_form.invoice_date.strftime("%Y-%m-%d"), "2022-05-31")
