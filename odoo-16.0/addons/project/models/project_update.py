...
class ProjectUpdate(models.Model):
    ...
    def _build_description(self, project):
        return self.env["ir.qweb"]._render(
            "project.project_update_default_description", self._get_template_values(project)
        )
    ...
    def _get_milestone_values(self, project):
        ...
        return {
            "show_section": (list_milestones or updated_milestones or created_milestones)
            and True
            or False,
    ...
    def _get_last_updated_milestone(self, project):
        ...
        mapped_result = {
            res["milestone_id"]: {"new_value": res["new_value"], "old_value": res["old_value"]}
            for res in results
        }
