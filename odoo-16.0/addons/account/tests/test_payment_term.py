...
class TestAccountPaymentTerms(AccountTestInvoicingCommon):
        ...
        cls.pay_term_1_month_end_of_month = cls.env["account.payment.term"].create(
            {
                ...
                "line_ids": [
                    (0, 0, {"value": "balance", "months": 1, "days": 0, "end_month": True}),
                ],
            }
        )
    ...
    def test_payment_term(self):
        ...
        self.assertPaymentTerm(
            self.pay_term_1_month_15_days_end_month_45_days, "2022-01-01", ["2022-04-14"]
        )
        self.assertPaymentTerm(
            self.pay_term_1_month_15_days_end_month_45_days, "2022-01-15", ["2022-05-15"]
        )
        self.assertPaymentTerm(
            self.pay_term_1_month_15_days_end_month_45_days, "2022-01-31", ["2022-05-15"]
        )
