...
class HolidaysAllocation(models.Model):
    ...
    overtime_id = fields.Many2one(
        "hr.attendance.overtime", string="Extra Hours", groups="hr_holidays.group_hr_holidays_user"
    )
            ...
            if allocation.overtime_deductible and allocation.holiday_type == "employee":
                ...
                if duration > allocation.employee_id.total_overtime:
                    raise ValidationError(
                        _("The employee does not have enough overtime hours to request this leave.")
                    )
    ...
    def action_draft(self):
        ...
        if any(
            ...
            raise ValidationError(
                _("The employee does not have enough extra hours to request this allocation.")
            )
