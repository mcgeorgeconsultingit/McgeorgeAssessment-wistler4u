...
class PortalProjectAccount(PortalAccount, ProjectCustomerPortal):
    ...
    def portal_my_tasks_invoices(
        self, task_id=None, page=1, date_begin=None, date_end=None, sortby=None, filterby=None, **kw
    ):
...
class SaleTimesheetCustomerPortal(TimesheetCustomerPortal):
    ...
    def _get_groupby_mapping(self):
        ...
        groupby_mapping.update(sol="so_line", so="order_id", invoice="timesheet_invoice_id")
        return groupby_mapping

    def _get_searchbar_sortings(self):
        searchbar_sortings = super()._get_searchbar_sortings()
        searchbar_sortings.update(sol={"label": _("Sales Order Item"), "order": "so_line"})
    ...
    @http.route(
        ["/my/timesheets", "/my/timesheets/page/<int:page>"], type="http", auth="user", website=True
    )
    def portal_my_timesheets(
        self, page=1, sortby=None, filterby=None, search=None, search_in="all", groupby="sol", **kw
    ):
