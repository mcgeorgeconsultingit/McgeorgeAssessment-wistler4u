...
class TestTransferWizard(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.env["res.currency.rate"].search(
            [("company_id", "=", cls.company.id), ("currency_id", "=", cls.company.currency_id.id)]
        ).write({"rate": 1})
    ...
    def test_transfer_wizard_grouping(self):
        ...
        self.assertAlmostEqual(
            groups[(self.accounts[0], self.partner_a, self.company_data["currency"])].balance,
            -800,
            self.company.currency_id.decimal_places,
        )
        self.assertAlmostEqual(
        ...
        self.assertAlmostEqual(
            groups[(self.accounts[1], self.partner_b, self.company_data["currency"])].balance,
            -480,
            self.company.currency_id.decimal_places,
        )
        self.assertAlmostEqual(
            groups[(self.accounts[2], self.partner_a, self.company_data["currency"])].balance,
            1030,
            self.company.currency_id.decimal_places,
        )
        self.assertAlmostEqual(
        ...
        self.assertAlmostEqual(
            groups[(self.accounts[3], self.partner_a, self.company_data["currency"])].balance,
            -250,
            self.company.currency_id.decimal_places,
        )
