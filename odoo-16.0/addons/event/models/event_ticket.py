...
class EventTemplateTicket(models.Model):
    ...
    # description
    name = fields.Char(
        string="Name", default=lambda self: _("Registration"), required=True, translate=True
    )
    ...
    seats_limited = fields.Boolean(
        string="Limit Attendees", readonly=True, store=True, compute="_compute_seats_limited"
    )
...
class EventTicket(models.Model):
    ...
    @api.depends(
        "is_expired", "start_sale_datetime", "event_id.date_tz", "seats_available", "seats_max"
    )
