...
class TestWarehouse(TestStockCommon):
    ...
    def test_inventory_product(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._gather(self.product_1, self.warehouse_1.lot_stock_id).quantity,
            35.0,
        )
        self.assertEqual(
            self.env["stock.quant"]
    ...
    def test_basic_move(self):
        ...
        self.assertEqual(
            customer_move.location_dest_id, self.env.ref("stock.stock_location_customers")
        )
    ...
    def test_toggle_active_warehouse_2(self):
        ...
        warehouse.reception_route_id.write({"warehouse_ids": [(4, self.warehouse_1.id)]})
