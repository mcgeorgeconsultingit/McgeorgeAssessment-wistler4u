...
class TestAccountPaymentRegister(AccountTestInvoicingCommon):
        ...
        cls.out_invoice_1 = cls.env["account.move"].create(
            {
                ...
                "invoice_line_ids": [
                    (0, 0, {"product_id": cls.product_a.id, "price_unit": 1000.0, "tax_ids": []})
                ],
            }
        )
        cls.out_invoice_2 = cls.env["account.move"].create(
            {
                ...
                "currency_id": cls.currency_data["currency"].id,
                "invoice_line_ids": [
                    (0, 0, {"product_id": cls.product_a.id, "price_unit": 2000.0, "tax_ids": []})
                ],
            }
        )
        cls.out_invoice_3 = cls.env["account.move"].create(
            {
                ...
                "currency_id": cls.currency_data["currency"].id,
                "invoice_line_ids": [
                    (0, 0, {"product_id": cls.product_a.id, "price_unit": 24.02, "tax_ids": []})
                ],
            }
        )
        cls.out_invoice_4 = cls.env["account.move"].create(
            {
                ...
                "currency_id": cls.currency_data["currency"].id,
                "invoice_line_ids": [
                    (0, 0, {"product_id": cls.product_a.id, "price_unit": 23.98, "tax_ids": []})
                ],
            }
        )
        (
            cls.out_invoice_1 + cls.out_invoice_2 + cls.out_invoice_3 + cls.out_invoice_4
        ).action_post()
        ...
        cls.in_invoice_3 = cls.env["account.move"].create(
            {
                ...
                "currency_id": cls.currency_data["currency"].id,
                "invoice_line_ids": [
                    (0, 0, {"product_id": cls.product_a.id, "price_unit": 3000.0, "tax_ids": []})
                ],
            }
        )
        ...
        cls.in_refund_1 = cls.env["account.move"].create(
            {
                ...
                "partner_id": cls.partner_a.id,
                "invoice_line_ids": [
                    (0, 0, {"product_id": cls.product_a.id, "price_unit": 1600.0, "tax_ids": []})
                ],
            }
        )
    ...
    def test_register_payment_single_batch_not_grouped(self):
        ...
        self.assertRecordValues(
            payments[0].line_ids.sorted("balance") + payments[1].line_ids.sorted("balance"),
            [
