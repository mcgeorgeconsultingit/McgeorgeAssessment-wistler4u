...
class Sponsor(models.Model):
    ...
    _rec_name = "name"
    _inherit = ["mail.thread", "mail.activity.mixin", "website.published.mixin", "chat.room.mixin"]
    ...
    @api.depends(
        "event_id.is_ongoing", "hour_from", "hour_to", "event_id.date_begin", "event_id.date_end"
    )
