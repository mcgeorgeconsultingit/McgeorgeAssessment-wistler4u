...
class RatingParentMixin(models.AbstractModel):
    ...
    rating_count = fields.Integer(
        string="# Ratings", compute="_compute_rating_percentage_satisfaction", compute_sudo=True
    )
    ...
    def _compute_rating_percentage_satisfaction(self):
        ...
        for record in self:
            ...
            record.rating_avg = (
                rating_scores_per_parent[record.id] / rating_count if rating_count else 0
            )
    ...
    def _search_rating_avg(self, operator, value):
        ...
        rating_read_group = (
            ...
            .sudo()
            .read_group(domain, ["parent_res_id", "rating_avg:avg(rating)"], ["parent_res_id"])
        )
        parent_res_ids = [
            res["parent_res_id"]
