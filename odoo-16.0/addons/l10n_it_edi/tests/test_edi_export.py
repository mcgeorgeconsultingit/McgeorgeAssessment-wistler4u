...
class TestItEdiExport(TestItEdi):
                        ...
                        (
                            ...
                            0,
                            {
                                **cls.standard_line,
                                ...
                                "tax_ids": [
                                    (6, 0, [cls.tax_zero_percent_hundred_percent_repartition.id])
                                ],
                            },
                        ),
                        (
                            ...
                            0,
                            {
                                **cls.standard_line,
                                ...
                                "tax_ids": [
                                    (6, 0, [cls.tax_zero_percent_zero_percent_repartition.id])
                                ],
                            },
                        ),
                    ],
    ...
    def test_price_included_taxes(self):
        ...
        invoice_etree = etree.fromstring(
            self.edi_format._l10n_it_edi_export_invoice_as_xml(self.price_included_invoice)
        )
    ...
    def test_partially_discounted_invoice(self):
        ...
        invoice_etree = etree.fromstring(
            self.edi_format._l10n_it_edi_export_invoice_as_xml(self.partial_discount_invoice)
        )
        expected_etree = self.with_applied_xpath(
            etree.fromstring(self.edi_basis_xml),
            """
    ...
    def test_fully_discounted_inovice(self):
        invoice_etree = etree.fromstring(
            self.edi_format._l10n_it_edi_export_invoice_as_xml(self.full_discount_invoice)
        )
        expected_etree = self.with_applied_xpath(
            etree.fromstring(self.edi_basis_xml),
            """
    ...
    def test_non_latin_and_latin_invoice(self):
        invoice_etree = etree.fromstring(
            self.edi_format._l10n_it_edi_export_invoice_as_xml(self.non_latin_and_latin_invoice)
        )
        expected_etree = self.with_applied_xpath(
            etree.fromstring(self.edi_basis_xml),
            """
    ...
    def test_send_pa_partner(self):
        ...
        self.assertEqual(
            ...
            {"attachment": self.pa_partner_invoice.l10n_it_edi_attachment_id, "success": True},
        )
    ...
    def test_negative_price_invoice(self):
        invoice_etree = etree.fromstring(
            self.edi_format._l10n_it_edi_export_invoice_as_xml(self.negative_price_invoice)
        )
        expected_etree = self.with_applied_xpath(
            etree.fromstring(self.edi_basis_xml),
            """
