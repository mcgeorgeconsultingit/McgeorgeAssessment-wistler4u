...
class ResConfigSettings(models.TransientModel):
    ...
    group_stock_tracking_lot = fields.Boolean("Packages", implied_group="stock.group_tracking_lot")
    ...
    def set_values(self):
        ...
        was_operations_showed = (
            self.env["stock.picking.type"].with_user(SUPERUSER_ID)._default_show_operations()
        )
        super().set_values()
        ...
        if (
            ...
            and self.env["stock.picking.type"].with_user(SUPERUSER_ID)._default_show_operations()
        ):
