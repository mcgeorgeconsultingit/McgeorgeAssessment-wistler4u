...
class TestInventory(TransactionCase):
    ...
    def test_inventory_1(self):
        ...
        self.assertEqual(
            len(self.env["stock.quant"]._gather(self.product1, self.stock_location)), 1.0
        )
        self.assertEqual(
        ...
        # check
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location), 0.0
        )
        self.assertEqual(
            sum(
    ...
    def test_inventory_2(self):
        ...
        self.assertEqual(
            len(self.env["stock.quant"]._gather(self.product2, self.stock_location, lot_id=lot1)),
            1.0,
        )
    ...
    def test_inventory_4(self):
        ...
        self.assertEqual(
            len(self.env["stock.quant"]._gather(self.product2, self.stock_location, strict=True)),
            1.0,
        )
        self.assertEqual(
            len(self.env["stock.quant"]._gather(self.product2, self.stock_location)), 2.0
        )
    ...
    def test_inventory_6(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._gather(self.product1, self.pack_location).quantity, 10.0
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.pack_location), 0.0
        )
        ...
        inventory_quant.action_apply_inventory()
        self.assertEqual(
            self.env["stock.quant"]._gather(self.product1, self.pack_location).quantity, 8.0
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.pack_location), 0
        )
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.pack_location), 2
        )
    ...
    def test_inventory_7(self):
        ...
        self.assertEqual(
            len(self.env["stock.quant"]._gather(self.product1, self.stock_location)), 2.0
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location), 2.0
        )
    ...
    def test_cyclic_inventory(self):
        ...
        self.assertEqual(
            quant_non_cyclic_loc.inventory_date.day, no_cyclic_loc.company_id.annual_inventory_day
        )
