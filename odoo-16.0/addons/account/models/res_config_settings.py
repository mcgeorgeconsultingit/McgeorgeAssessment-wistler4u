...
class ResConfigSettings(models.TransientModel):
    ...
    use_invoice_terms = fields.Boolean(
        string="Default Terms & Conditions", config_parameter="account.use_invoice_terms"
    )
    ...
    early_pay_discount_computation = fields.Selection(
        related="company_id.early_pay_discount_computation", string="Tax setting", readonly=False
    )
    ...
    def _compute_has_chart_of_accounts(self):
        ...
        self.has_accounting_entries = self.env["account.chart.template"].existing_accounting(
            self.company_id
        )
