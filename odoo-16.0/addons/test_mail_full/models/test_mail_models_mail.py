...
class MailTestRating(models.Model):
    ...
    email_from = fields.Char(
        compute="_compute_email_from", precompute=True, readonly=False, store=True
    )
    mobile_nbr = fields.Char(
        compute="_compute_mobile_nbr", precompute=True, readonly=False, store=True
    )
    phone_nbr = fields.Char(
        compute="_compute_phone_nbr", precompute=True, readonly=False, store=True
    )
