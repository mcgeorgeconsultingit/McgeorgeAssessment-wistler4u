...
class HrEmployeeBase(models.AbstractModel):
    ...
    goal_ids = fields.One2many(
        "gamification.goal", string="Employee HR Goals", compute="_compute_employee_goals"
    )
    ...
    direct_badge_ids = fields.One2many(
        "gamification.badge.user", "employee_id", help="Badges directly linked to the employee"
    )
