...
class ResConfigSettings(models.TransientModel):
    ...
    website_homepage_url = fields.Char(related="website_id.homepage_url", readonly=False)
    ...
    website_default_lang_code = fields.Char(
        "Default language code", related="website_id.default_lang_id.code", readonly=False
    )
    ...
    google_analytics_key = fields.Char(
        "Google Analytics Key", related="website_id.google_analytics_key", readonly=False
    )
    google_search_console = fields.Char(
        "Google Search Console", related="website_id.google_search_console", readonly=False
    )
    ...
    plausible_site = fields.Char(
        "Plausible Site (e.g. domain.com)", related="website_id.plausible_site", readonly=False
    )
    ...
    social_default_image = fields.Binary(
        "Default Social Share Image", related="website_id.social_default_image", readonly=False
    )
