...
class ProductReplenish(models.TransientModel):
    ...
    date_planned = fields.Datetime(
        "Scheduled Date", required=True, help="Date at which the replenishment should take place."
    )
    ...
    def _onchange_product_id(self):
        self.quantity = (
            abs(self.product_id.virtual_available) if self.product_id.virtual_available < 0 else 1
        )
