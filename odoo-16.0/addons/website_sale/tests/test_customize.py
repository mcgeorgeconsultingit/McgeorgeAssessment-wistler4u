...
class TestUi(HttpCaseWithUserDemo, HttpCaseWithUserPortal):
            ...
            [
                {
                    ...
                    "value_ids": [
                        (6, 0, [product_attribute_value_1.id, product_attribute_value_2.id])
                    ],
                }
            ]
        )
    ...
    def test_02_admin_shop_custom_attribute_value_tour(self):
        ...
        self.product_product_11_product_template.attribute_line_ids[0].product_template_value_ids[
            1
        ].price_extra = 6.40
        ...
        for pricelist in pricelists:
            if not pricelist.item_ids.filtered(
                lambda i: i.product_tmpl_id == product_template and i.price_discount == 20
            ):
            ...
            [
                {
                    ...
                    "value_ids": [
                        (
                            6,
                            0,
                            attribute_values.filtered(lambda v: v.attribute_id == attribute_1).ids,
                        )
                    ],
                },
                {
                    ...
                    "value_ids": [
                        (
                            6,
                            0,
                            attribute_values.filtered(lambda v: v.attribute_id == attribute_2).ids,
                        )
                    ],
                },
                {
                    ...
                    "value_ids": [
                        (
                            6,
                            0,
                            attribute_values.filtered(lambda v: v.attribute_id == attribute_3).ids,
                        )
                    ],
                },
            ]
