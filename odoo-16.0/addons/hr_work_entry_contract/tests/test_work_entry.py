...
class TestWorkEntry(TestWorkEntryBase):
    ...
    def test_approve_multiple_day_work_entry(self):
        ...
        self.assertTrue(
            all((b.state == "validated" for b in work_entries)), "Work entries should be approved"
        )
    ...
    def test_validate_undefined_work_entry(self):
        ...
        self.assertFalse(
            work_entry1.action_validate(), "It should not validate work_entries without a type"
        )
