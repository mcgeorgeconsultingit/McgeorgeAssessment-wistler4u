...
class TestAccountAnalyticAccount(AccountTestInvoicingCommon):
    ...
    def test_model_score(self):
        ...
        self.assertEqual(
            invoice.invoice_line_ids.analytic_distribution, {str(self.analytic_account_b.id): 100}
        )
        ...
        self.assertEqual(
            invoice.invoice_line_ids.analytic_distribution, {str(self.analytic_account_a.id): 100}
        )
    ...
    def test_model_application(self):
        ...
        with Form(invoice) as invoice_form:
            ...
            with invoice_form.invoice_line_ids.edit(0) as line_form:
                self.assertEqual(
                    line_form.analytic_distribution, {str(self.analytic_account_a.id): 100}
                )
