...
class EventType(models.Model):
    ...
    question_ids = fields.One2many("event.question", "event_type_id", string="Questions", copy=True)
...
class EventEvent(models.Model):
    ...
    general_question_ids = fields.One2many(
        "event.question", "event_id", "General Questions", domain=[("once_per_order", "=", True)]
    )
    specific_question_ids = fields.One2many(
        "event.question", "event_id", "Specific Questions", domain=[("once_per_order", "=", False)]
    )
