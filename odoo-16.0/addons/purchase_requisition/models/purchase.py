    ...
    def get_tender_best_lines(self):
        ...
        for line in order_lines:
            ...
            if (
                ...
                product_to_best_price_line[line.product_id][0].price_subtotal == line.price_subtotal
            ):
                product_to_best_price_line[line.product_id] |= line
            if (
                not product_to_best_date_line[line.product_id]
                or product_to_best_date_line[line.product_id][0].date_planned > line.date_planned
            ):
            ...
            if (
                ...
                or product_to_best_price_unit[line.product_id][0].price_unit > line.price_unit
            ):
