...
class TestProjectBillingMulticompany(TestCommonSaleTimesheet):
    ...
    def test_makeBillable_multiCompany(self):
        wizard = (
            ...
            .with_context(
                allowed_company_ids=[self.company_data_2["company"].id, self.env.company.id],
        ...
        self.assertEqual(
            ...
            self.project_non_billable.company_id.id,
            "The company on the sale order should be the same as the one on the project",
        )
