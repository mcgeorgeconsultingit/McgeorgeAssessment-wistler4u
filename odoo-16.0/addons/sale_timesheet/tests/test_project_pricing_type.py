...
class TestProjectPricingType(TestCommonSaleTimesheet):
    def test_pricing_type(self):
        ...
        self.assertTrue(
            project.allow_billable, "The allow_billable should be updated and equal to True."
        )
        ...
        self.assertEqual(
            project.pricing_type, "task_rate", "The pricing type should be equal to task_rate."
        )
        self.assertTrue(project.filtered_domain(project._search_pricing_type("=", "task_rate")))
        self.assertFalse(project.filtered_domain(project._search_pricing_type("=", "fixed_rate")))
        self.assertFalse(
        ...
        self.assertEqual(
            len(project.sale_line_employee_ids), 1, "The project should have an employee mapping."
        )
        self.assertEqual(
            project.pricing_type,
            "employee_rate",
