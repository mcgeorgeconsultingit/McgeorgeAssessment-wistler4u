...
class test_search(TransactionCase):
    ...
    def test_13_m2o_order_loop_multi(self):
        ...
        kw = dict(
            groups_id=[
                Command.set([self.ref("base.group_system"), self.ref("base.group_partner_manager")])
            ]
        )
    ...
    def test_20_x_active(self):
        ...
        self.assertIn(
            country_ussr, ussr_search, "Search with active_test on a custom x_active field failed"
        )
