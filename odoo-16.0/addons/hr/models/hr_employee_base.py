        ...
        for employee in self:
            ...
            if last_presence:
                last_activity_datetime = (
                    last_presence.replace(tzinfo=UTC).astimezone(timezone(tz)).replace(tzinfo=None)
                )
    ...
    def _get_employee_working_now(self):
        ...
        for tz in all_employee_tz:
            ...
            for calendar_id in resource_calendar_ids:
                ...
                work_interval = res_employee_ids[0].resource_calendar_id._work_intervals_batch(
