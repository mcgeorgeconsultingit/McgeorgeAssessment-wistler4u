...
class AccountPayment(models.Model):
    ...
    def _compute_show_check_number(self):
        for payment in self:
            payment.show_check_number = (
                payment.payment_method_line_id.code == "check_printing" and payment.check_number
            )
    ...
    def print_checks(self):
        ...
        self = self.filtered(
            lambda r: r.payment_method_line_id.code == "check_printing" and r.state != "reconciled"
        )
        ...
        def prepare_vals(invoice, partials):
            ...
            return {
                ...
                "amount_total": formatLang(
                    self.env, invoice_sign * invoice.amount_total, currency_obj=invoice.currency_id
                ),
