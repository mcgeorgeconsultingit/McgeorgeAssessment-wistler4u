...
class TestWebsiteResetViews(odoo.tests.HttpCase):
    ...
    def test_01_reset_specific_page_view(self):
        ...
        self.assertEqual(
            total_views + 1, self.View.search_count([("type", "=", "qweb")]), "Missing COW view"
        )
    ...
    def test_02_reset_specific_view_controller(self):
        ...
        break_view(
            self.test_view.with_context(website_id=1), to='<p t-att-data="no_record.exist" />'
        )
        self.assertEqual(
            total_views + 1, self.View.search_count([("type", "=", "qweb")]), "Missing COW view"
        )
    ...
    def test_06_reset_specific_view_controller_inexisting_template(self):
        ...
        self.assertEqual(
            total_views + 1, self.View.search_count([("type", "=", "qweb")]), "Missing COW view (2)"
        )
        self.fix_it("/test_view")
