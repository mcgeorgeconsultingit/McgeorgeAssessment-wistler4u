...
class Warehouse(models.Model):
    ...
    def _populate_factories(self):
        ...
        return [
            ...
            (
                "reception_steps",
                populate.iterate(["one_step", "two_steps", "three_steps"], [0.6, 0.2, 0.2]),
            ),
            (
                "delivery_steps",
                populate.iterate(["ship_only", "pick_ship", "pick_pack_ship"], [0.6, 0.2, 0.2]),
            ),
        ]
    ...
    def _populate(self, size):
        ...
        for company_id in company_ids:
            ...
            for warehouse in warehouses:
                ...
                nb_by_level = (
                    int(math.log(nb_loc_to_take, depth)) + 1 if depth > 1 else nb_loc_to_take
...
class StockWarehouseOrderpoint(models.Model):
    ...
    def _populate_factories(self):
        ...
        valid_product = {
            company_id: list(product_ids) for company_id, product_ids in valid_product.items()
        }
