    ...
    def _l10n_cl_prices_and_taxes(self):
        ...
        if not included_taxes:
            ...
            price_subtotal = included_taxes.compute_all(
                price, invoice.currency_id, self.quantity, self.product_id, invoice.partner_id
            )["total_included"]
        price_net = price_unit * (1 - (self.discount or 0.0) / 100.0)

        return {"price_unit": price_unit, "price_subtotal": price_subtotal, "price_net": price_net}
