...
class TestCrmMailActivity(TestCrmCommon):
    ...
    def test_crm_activity_recipients(self):
        ...
        internal_subtypes = (
            self.lead_1.message_follower_ids.filtered(lambda fol: fol.partner_id == self.contact_1)
            .mapped("subtype_ids")
        ...
        self.lead_1.message_subscribe(
            ...
            subtype_ids=[self.env.ref("mail.mt_activities").id, self.env.ref("mail.mt_comment").id],
        )
