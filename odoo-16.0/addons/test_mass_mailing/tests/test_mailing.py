...
class TestMassMailing(TestMassMailCommon):
    ...
    def test_mailing_reply_to_mode_new(self):
        ...
        self.assertEqual(
            answer_rec.message_ids.subject, "Re: %s" % mailing.subject, "Answer should be logged"
        )
