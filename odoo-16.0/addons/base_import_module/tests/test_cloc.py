...
class TestClocFields(test_cloc.TestClocCustomization):
    ...
    def test_fields_from_import_module(self):
        ...
        self.assertEqual(
            cl.code.get("imported_module", 0), 1, "Count fields with xml_id of imported module"
        )
    ...
    def test_fields_from_studio(self):
        ...
        cl.count_customization(self.env)
        self.assertEqual(
            cl.code.get("studio_customization", 0), 0, "Don't count field generated by studio"
        )
        ...
        cl.count_customization(self.env)
        self.assertEqual(
            cl.code.get("studio_customization", 0), 1, "Count manual field created via studio"
        )
    ...
    def test_count_qweb_imported_module(self):
        ...
        cl.count_customization(self.env)
        self.assertEqual(
            cl.code.get("test_imported_module", 0), 5, "Count only qweb view from imported module"
        )
        self.assertEqual(
    ...
    def test_exclude_qweb(self):
        ...
        cl.count_customization(self.env)
        self.assertEqual(
            cl.code.get("test_imported_module", 0), 0, "Do not count view with cloc_exclude"
        )
