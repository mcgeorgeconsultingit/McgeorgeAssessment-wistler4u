...
class TestVideoUtils(common.BaseCase):
    ...
    def test_player_regexes(self):
        ...
        # dailymotion
        self.assertIsNotNone(
            re.search(tools.player_regexes["dailymotion"], TestVideoUtils.urls["dailymotion"])
        )
        # youku
        self.assertIsNotNone(re.search(tools.player_regexes["youku"], TestVideoUtils.urls["youku"]))
        # instagram
        self.assertIsNotNone(
            re.search(tools.player_regexes["instagram"], TestVideoUtils.urls["instagram"])
        )
    ...
    def test_get_video_source_data(self):
        ...
        self.assertEqual(
            "xCvFZrrQq7k", tools.get_video_source_data(TestVideoUtils.urls["youtube"])[1]
        )
        # vimeo
        ...
        # dailymotion
        self.assertEqual(
            "dailymotion", tools.get_video_source_data(TestVideoUtils.urls["dailymotion"])[0]
        )
        self.assertEqual(
            "x7svr6t", tools.get_video_source_data(TestVideoUtils.urls["dailymotion"])[1]
        )
        self.assertEqual(
            None, tools.get_video_source_data(TestVideoUtils.urls["dailymotion_hub_no_video"])
        )
        self.assertEqual(
            "dailymotion",
            tools.get_video_source_data(TestVideoUtils.urls["dailymotion_hub_#video"])[0],
        )
        self.assertEqual(
            "x2jvvep", tools.get_video_source_data(TestVideoUtils.urls["dailymotion_hub_#video"])[1]
        )
        self.assertEqual(
        ...
        self.assertEqual(
            "dailymotion", tools.get_video_source_data(TestVideoUtils.urls["dailymotion_embed"])[0]
        )
        self.assertEqual(
            "x578has", tools.get_video_source_data(TestVideoUtils.urls["dailymotion_embed"])[1]
        )
        self.assertEqual(
            "dailymotion",
            tools.get_video_source_data(TestVideoUtils.urls["dailymotion_video_extra"])[0],
        )
        self.assertEqual(
            "x2jvvep",
            tools.get_video_source_data(TestVideoUtils.urls["dailymotion_video_extra"])[1],
        )
        # youku
        ...
        self.assertEqual(
            "XMTI5Mjg5NjE4MA", tools.get_video_source_data(TestVideoUtils.urls["player_youku"])[1]
        )
        self.assertEqual(
            "youku", tools.get_video_source_data(TestVideoUtils.urls["youku_embed"])[0]
        )
        self.assertEqual(
            "XNTIwMzE1MzUzNg", tools.get_video_source_data(TestVideoUtils.urls["youku_embed"])[1]
        )
        # instagram
        self.assertEqual(
            "instagram", tools.get_video_source_data(TestVideoUtils.urls["instagram"])[0]
        )
        self.assertEqual(
            "B6dXGTxggTG", tools.get_video_source_data(TestVideoUtils.urls["instagram"])[1]
        )
    ...
    def test_get_video_url_data(self):
        ...
        # youtube
        self.assertEqual(
            "youtube", tools.get_video_url_data(TestVideoUtils.urls["youtube"])["platform"]
        )
        # vimeo
        self.assertEqual(
        ...
        # dailymotion
        self.assertEqual(
            "dailymotion", tools.get_video_url_data(TestVideoUtils.urls["dailymotion"])["platform"]
        )
        # youku
        self.assertEqual(
        ...
        # instagram
        self.assertEqual(
            "instagram", tools.get_video_url_data(TestVideoUtils.urls["instagram"])["platform"]
        )
