...
class TestSoLineMilestones(TestSaleCommon):
    ...
    def test_compute_sale_line_in_task(self):
        ...
        self.assertEqual(
            task.sale_line_id, self.sol1, "The task should have the one of the project linked"
        )
        ...
        self.assertEqual(
            task.sale_line_id, self.sol1, "The task should keep the SOL linked to the milestone."
        )
