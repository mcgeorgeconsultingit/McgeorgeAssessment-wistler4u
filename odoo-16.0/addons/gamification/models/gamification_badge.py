...
class GamificationBadge(models.Model):
    ...
    granted_count = fields.Integer(
        "Total", compute="_get_owners_info", help="The number of time this badge has been received."
    )
    ...
    remaining_sending = fields.Integer(
        "Remaining Sending Allowed", compute="_remaining_sending_calc", help="If a maximum is set"
    )
