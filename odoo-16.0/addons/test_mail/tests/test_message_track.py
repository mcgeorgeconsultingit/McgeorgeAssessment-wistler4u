...
class TestTracking(TestMailCommon):
    ...
    def test_message_track_template(self):
        ...
        self.assertSentEmail(
            self.record.env.user.partner_id, [self.partner_admin], body="<p>Hello Test2</p>"
        )
    ...
    def test_message_track_template_at_create(self):
        ...
        # one email send due to template
        self.assertSentEmail(
            self.record.env.user.partner_id, [self.partner_admin], body="<p>Hello Test</p>"
        )
...
class TestTrackingInternals(TestMailCommon):
    ...
    def test_track_groups(self):
        ...
        self.assertEqual(
            msg_emp[0].get("trackingValues"), [], "should not have protected tracking values"
        )
        self.assertEqual(
