...
class website_form_model(models.Model):
    ...
    website_form_access = fields.Boolean(
        "Allowed to use in forms", help="Enable the form builder feature for this model."
    )
    ...
    def _get_form_writable_fields(self):
        ...
        included = {
            ...
            .sudo()
            .search([("model_id", "=", self.id), ("website_form_blacklisted", "=", False)])
        }
...
class website_form_model_fields(models.Model):
    ...
    def init(self):
        ...
        self._cr.execute(
            "ALTER TABLE ir_model_fields " " ALTER COLUMN website_form_blacklisted SET DEFAULT true"
        )
