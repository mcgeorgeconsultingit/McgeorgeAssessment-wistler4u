...
class BaseTestUi(odoo.tests.HttpCase):
    def main_flow_tour(self):
        ...
        Property._set_default(
            "property_account_expense_categ_id", "product.category", a_expense, self.env.company
        )
        Property._set_default(
            "property_account_income_categ_id", "product.category", a_sale, self.env.company
        )
