    ...
    def _compute_product_margin_fields_values(self, field_names=None):
        ...
        for product_id, avg, qty, total, sale in self.env.cr.fetchall():
            ...
            res[product_id]["expected_margin_rate"] = (
                ...
                and res[product_id]["expected_margin"] * 100 / res[product_id]["sale_expected"]
                or 0.0
            )
        ...
        for product_id, avg, qty, total, dummy in self.env.cr.fetchall():
            ...
            res[product_id]["total_margin_rate"] = (
                ...
                and res[product_id]["total_margin"] * 100 / res[product_id].get("turnover", 0.0)
                or 0.0
            )
        for product in self:
            ...
            res[product.id]["expected_margin"] = (
                res[product.id].get("sale_expected", 0.0) - res[product.id]["normal_cost"]
            )
