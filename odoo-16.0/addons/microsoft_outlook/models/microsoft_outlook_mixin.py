...
class MicrosoftOutlookMixin(models.AbstractModel):
    ...
    is_microsoft_outlook_configured = fields.Boolean(
        "Is Outlook Credential Configured", compute="_compute_is_microsoft_outlook_configured"
    )
    ...
    microsoft_outlook_access_token_expiration = fields.Integer(
        string="Outlook Access Token Expiration Timestamp", groups="base.group_system", copy=False
    )
