...
class TestPurchaseLeadTime(PurchaseTestCommon):
    ...
    def test_merge_po_line_3(self):
        ...
        self.assertEqual(
            len(purchase_order.order_line), 1, "line with same custom value should be merged"
        )
        self.assertEqual(
    ...
    def test_reordering_days_to_purchase(self):
        ...
        self.assertEqual(
            fields.Date.to_date(new_order.date_order), fields.Date.today() + timedelta(days=2)
        )
