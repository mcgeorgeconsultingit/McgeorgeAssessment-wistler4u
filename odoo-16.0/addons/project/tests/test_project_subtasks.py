...
class TestProjectSubtasks(TestProjectCommon):
    ...
    def test_subtask_display_project(self):
        ...
        self.assertFalse(
            self.task_1.child_ids.display_project_id, "Display Project of the task should be False"
        )
        self.assertEqual(
            self.task_1.child_ids.project_id,
            self.project_goats,
        ...
        self.assertEqual(
            self.task_1.project_id, self.project_pigs, "Parent project should change back."
        )
        self.assertEqual(
            self.task_1.child_ids.display_project_id,
            self.project_goats,
