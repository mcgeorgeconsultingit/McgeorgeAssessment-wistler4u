...
class TestCreateRecurrentEvents(TestRecurrentEvents):
    ...
    def test_videocall_recurrency(self):
        ...
        self.assertEqual(
            detached_events[0].videocall_channel_id.id, self.event.videocall_channel_id.id
        )
...
class TestUpdateRecurrentEvents(TestRecurrentEvents):
    ...
    def test_shift_all_base_inactive(self):
        ...
        self.assertFalse(
            self.recurrence.calendar_event_ids, "Inactive event should not create recurrent events"
        )
