...
class AccountMove(models.Model):
    ...
    def _get_l10n_latam_documents_domain(self):
        self.ensure_one()
        if (
            self.journal_id.company_id.account_fiscal_country_id != self.env.ref("base.cl")
        ...
        if self.partner_id.l10n_cl_sii_taxpayer_type == "1" and self.partner_id_vat != "60805000-0":
            ...
            self.partner_id.l10n_cl_sii_taxpayer_type == "1" and self.partner_id_vat == "60805000-0"
        ):
    ...
    def _l10n_cl_get_invoice_totals_for_report(self):
        ...
        if include_sii:
            ...
            tax_totals["amount_untaxed"] = self.currency_id.round(
                ...
                - sum([x["tax_amount"] for x in tax_line_vals_list if "tax_amount" in x])
            )
