...
class TestMultiCompany(TransactionCase):
    ...
    def test_intercom_lot_push(self):
        ...
        self.assertFalse(
            move_push in move_to_transit.move_dest_ids, "Chained move created in transit location"
        )
        self.assertNotEqual(
            move_push.move_line_ids.lot_id, move_line_2.lot_id, "Reserved from transit location"
        )
    ...
    def test_intercom_lot_pull(self):
        ...
        self.assertTrue(
            move_wha_to_cus in move_transit_to_wha.move_dest_ids, "Moves are not chained"
        )
        self.assertFalse(
