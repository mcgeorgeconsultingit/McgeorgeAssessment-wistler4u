...
class TestPoSProductsWithTax(TestPoSCommon):
        ...
        self._run_test(
            {
                ...
                "orders": [
                    ...
                    {
                        "pos_order_lines_ui_args": [(self.product2, 7), (self.product3, 4)],
                        "uid": "00100-010-0002",
                    },
                    {
        ...
        self._run_test(
            {
                ...
                "orders": [
                    ...
                    {
                        "pos_order_lines_ui_args": [(self.product2, 20), (self.product1, 1)],
                        "payments": [(self.bank_pm1, 410.7)],
                        "uid": "00100-010-0002",
                    },
                    {
                        "pos_order_lines_ui_args": [(self.product1, 10), (self.product3, 10)],
    ...
    def test_return_order(self):
        ...
        def _after_closing_cb():
            ...
            for t1, t2 in zip(
                ...
                self.assertAlmostEqual(
                    t1, t2, msg="Taxes should be correctly combined and should be debit."
                )
    ...
    def test_pos_create_correct_account_move(self):
        ...
        self.assertEqual(
            2, len(lines.filtered(lambda l: l.tax_ids)), "Taxes should have been set on 2 lines"
        )
        self.assertEqual(
            4, len(lines.filtered(lambda l: l.tax_tag_ids)), "Tags should have been set on 4 lines"
        )
