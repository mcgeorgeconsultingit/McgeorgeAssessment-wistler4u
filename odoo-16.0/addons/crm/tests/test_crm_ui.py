...
class TestUi(HttpCase):
        ...
        self.env["res.users"].create(
            {
                ...
                "groups_id": [
                    (
                        6,
                        0,
                        [self.ref("base.group_user"), self.ref("sales_team.group_sale_salesman")],
                    )
                ],
            }
        )
    ...
    def test_email_and_phone_propagation_edit_save(self):
        ...
        self.assertEqual(
            lead.email_from, "test@example.com", "Should not have changed the lead email"
        )
    ...
    def test_email_and_phone_propagation_remove_email_and_phone(self):
        ...
        self.start_tour(
            "/web", "crm_email_and_phone_propagation_remove_email_and_phone", login="admin"
        )
