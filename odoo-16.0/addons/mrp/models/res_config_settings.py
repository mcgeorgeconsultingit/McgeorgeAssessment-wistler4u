...
class ResConfigSettings(models.TransientModel):
    ...
    manufacturing_lead = fields.Float(
        related="company_id.manufacturing_lead", string="Manufacturing Lead Time", readonly=False
    )
    use_manufacturing_lead = fields.Boolean(
        string="Default Manufacturing Lead Time", config_parameter="mrp.use_manufacturing_lead"
    )
    group_mrp_byproducts = fields.Boolean("By-Products", implied_group="mrp.group_mrp_byproducts")
    ...
    group_mrp_routings = fields.Boolean("MRP Work Orders", implied_group="mrp.group_mrp_routings")
    ...
    group_mrp_reception_report = fields.Boolean(
        "Allocation Report for Manufacturing Orders", implied_group="mrp.group_mrp_reception_report"
    )
