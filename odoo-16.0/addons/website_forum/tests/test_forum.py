...
class TestForum(TestForumCommon):
    ...
    def test_comment(self):
        ...
        self.assertEqual(
            len(self.post.message_ids), 4, "website_forum: wrong behavior of message_post"
        )
    ...
    def test_validate_a_post(self):
        ...
        post.with_user(self.user_portal).validate()
        self.assertEqual(
            post.state, "active", "website_forum: wrong state when validate a post after pending"
        )
        self.assertEqual(
        ...
        post.with_user(self.user_portal).validate()
        self.assertEqual(
            post.state, "active", "website_forum: wrong state when validate a post after flagged"
        )
        ...
        post.with_user(self.user_portal).validate()
        self.assertEqual(
            post.state, "active", "website_forum: wrong state when validate a post after offensive"
        )
    ...
    def test_refuse_a_post(self):
        ...
        post.with_user(self.user_portal).refuse()
        self.assertEqual(
            post.moderator_id, self.user_portal, "website_forum: wrong moderator_id when refusing"
        )
        self.assertEqual(
            post.create_uid.karma, init_karma, "website_forum: wrong karma when refusing a post"
        )
    ...
    def test_mark_a_post_as_offensive(self):
        ...
        post.with_user(self.user_portal).mark_as_offensive(12)
        self.assertEqual(
            post.state, "offensive", "website_forum: wrong state when marking a post as offensive"
        )
        self.assertEqual(
            post.create_uid.karma,
    ...
    def test_convert_answer_to_comment(self):
        ...
        self.assertEqual(
            new_msg.author_id, post_author, "website_forum: wrong answer to comment conversion"
        )
        self.assertIn(
            "I am an anteater", new_msg.body, "website_forum: wrong answer to comment conversion"
        )
    ...
    def test_forum_mode_questions(self):
        ...
        self.assertEqual(
            not questions_post.uid_has_answered or questions_post.forum_id.mode == "discussions",
            False,
        )
        self.assertEqual(
    ...
    def test_forum_mode_discussions(self):
        ...
        self.assertEqual(
            discussions_post.uid_has_answered and discussions_post.forum_id.mode == "questions",
            False,
        )
    ...
    def test_tag_creation_multi_forum(self):
        ...
        self.assertIn(
            forum_1, food_tags.forum_id, "One Food tag should have been created for forum 1."
        )
        self.assertIn(
            forum_2, food_tags.forum_id, "One Food tag should have been created for forum 2."
        )
