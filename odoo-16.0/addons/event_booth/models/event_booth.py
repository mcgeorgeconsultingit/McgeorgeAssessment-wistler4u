...
class EventBooth(models.Model):
    ...
    contact_name = fields.Char(
        "Renter Name", compute="_compute_contact_name", readonly=False, store=True, copy=False
    )
    contact_email = fields.Char(
        "Renter Email", compute="_compute_contact_email", readonly=False, store=True, copy=False
    )
    contact_mobile = fields.Char(
        "Renter Mobile", compute="_compute_contact_mobile", readonly=False, store=True, copy=False
    )
    contact_phone = fields.Char(
        "Renter Phone", compute="_compute_contact_phone", readonly=False, store=True, copy=False
    )
    # state
