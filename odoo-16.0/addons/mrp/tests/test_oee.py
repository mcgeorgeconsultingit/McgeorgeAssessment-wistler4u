...
class TestOee(TestMrpCommon):
    ...
    def test_wrokcenter_oee(self):
        ...
        self.assertEqual(
            self.workcenter_1.working_state, "blocked", "Wrong working state of workcenter."
        )
        ...
        self.assertEqual(
            self.workcenter_1.working_state, "normal", "Wrong working state of workcenter."
        )
        ...
        self.assertEqual(
            self.workcenter_1.blocked_time, blocked_time_in_hour, "Wrong block time on workcenter."
        )
        self.assertEqual(
        ...
        computed_oee = round(
            ((productive_time_in_hour * 100.0) / (productive_time_in_hour + blocked_time_in_hour)),
            2,
        )
