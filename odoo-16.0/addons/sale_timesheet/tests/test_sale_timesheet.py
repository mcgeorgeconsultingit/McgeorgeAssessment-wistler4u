...
class TestSaleTimesheet(TestCommonSaleTimesheet):
    ...
    def test_timesheet_order(self):
        ...
        self.assertEqual(
            sale_order.tasks_count, 1, "One task should have been created on SO confirmation"
        )
        self.assertEqual(
    ...
    def test_timesheet_delivery(self):
        ...
        self.assertTrue(
            float_is_zero(so_line_deliver_only_project.qty_delivered, precision_digits=2),
    ...
    def test_timesheet_manual(self):
        ...
        self.assertTrue(
            float_is_zero(so_line_manual_global_project.qty_delivered, precision_digits=2),
        ...
        self.assertFalse(
            timesheet1.timesheet_invoice_id, "The timesheet1 should not be linked to the invoice"
        )
        self.assertFalse(
            timesheet2.timesheet_invoice_id, "The timesheet2 should not be linked to the invoice"
        )
    ...
    def test_timesheet_upsell(self):
        ...
        last_message_id = (
            ...
            .search([("model", "=", "sale.order"), ("res_id", "=", sale_order.id)], limit=1)
            .id
            or 0
        )
        self.env["account.analytic.line"].create(
    ...
    def test_unlink_timesheet(self):
        ...
        self.assertEqual(
            analytic_line.timesheet_invoice_id, move, "The timesheet should be linked to move"
        )

        move.with_context(check_move_validity=False).line_ids[0].unlink()
        self.assertFalse(
            analytic_line.timesheet_invoice_id, "The timesheet should have been unlinked from move"
        )
