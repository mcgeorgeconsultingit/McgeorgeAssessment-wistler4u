...
class AccountEdiXmlCII(models.AbstractModel):
        ...
        constraints.update(
            {
                ...
                "seller_email": self._check_required_fields(vals["record"]["company_id"], "email"),
    ...
    def _export_invoice_vals(self, invoice):
        ...
        for tax_detail_vals in template_values["tax_details"]["tax_details"].values():
            ...
            tax_detail_vals["calculated_amount"] = (
                amount_currency if not invoice.currency_id.is_zero(amount_currency) else 0
            )
    ...
    def _import_fill_invoice_form(self, journal, tree, invoice, qty_factor):
        ...
        partner_type = (
            invoice.journal_id.type == "purchase" and "SellerTradeParty" or "BuyerTradeParty"
        )
