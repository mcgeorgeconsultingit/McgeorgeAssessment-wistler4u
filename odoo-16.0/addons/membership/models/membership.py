...
class MembershipLine(models.Model):
    ...
    account_invoice_line = fields.Many2one(
        "account.move.line", string="Account Invoice line", readonly=True, ondelete="cascade"
    )
    account_invoice_id = fields.Many2one(
        "account.move", related="account_invoice_line.move_id", string="Invoice", readonly=True
    )
