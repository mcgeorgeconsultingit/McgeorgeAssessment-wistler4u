...
class TestChannelStatistics(common.SlidesCase):
    ...
    def test_channel_statistics(self):
        ...
        self.assertEqual(
            ...
            len(
                channel_publisher.slide_content_ids.filtered(lambda s: s.slide_category == "video")
            ),
        )
        ...
        self.assertEqual(
            channel_publisher.partner_ids, self.user_officer.partner_id | self.user_emp.partner_id
        )
...
class TestSlideStatistics(common.SlidesCase):
    ...
    def test_slide_statistics_categories(self):
        ...
        self.assertEqual(
            other_category.total_slides, 0, "The other category should not contain any slide yet"
        )
