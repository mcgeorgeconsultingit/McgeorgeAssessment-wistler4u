...
class TestAccessFeatures(common.SlidesCase):
    ...
    def test_channel_auto_subscription(self):
        ...
        self.assertEqual(
            channel.partner_ids, user_employees.mapped("partner_id") | new_user.partner_id
        )
    ...
    def test_channel_access_fields_officer(self):
        ...
        channel_manager = self.channel.with_user(self.user_manager)
        channel_manager.write({"upload_group_ids": [(5, 0)], "user_id": self.user_manager.id})
    ...
    @mute_logger(
        "odoo.models.unlink", "odoo.addons.base.models.ir_rule", "odoo.addons.base.models.ir_model"
    )
