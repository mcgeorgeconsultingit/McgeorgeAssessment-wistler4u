...
class TestUiSession(HttpCase):
    def test_admin_survey_session(self):
        ...
        simple_choice_answer_1 = self.env["survey.question.answer"].create({"value": "First"})
        simple_choice_answer_2 = self.env["survey.question.answer"].create({"value": "Second"})
        simple_choice_answer_3 = self.env["survey.question.answer"].create({"value": "Third"})
        ...
        scored_choice_answer_2 = self.env["survey.question.answer"].create({"value": "Incorrect 1"})
        scored_choice_answer_3 = self.env["survey.question.answer"].create({"value": "Incorrect 2"})
        scored_choice_answer_4 = self.env["survey.question.answer"].create({"value": "Incorrect 3"})
        ...
        attendee_3.save_lines(timed_scored_choice_question, [timed_scored_choice_answer_2.id])
