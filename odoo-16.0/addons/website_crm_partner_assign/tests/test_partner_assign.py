...
class TestPartnerAssign(TransactionCase):
    def setUp(self):
        ...
        patcher = patch(
            "odoo.addons.base_geolocalize.models.base_geocoder.GeoCoder.geo_find", wraps=geo_find
        )
    ...
    def test_opportunity_count(self):
        ...
        self.assertEqual(
            ...
            repr(
                [("id", "in", sorted(self.lead_uk.ids + lead_uk_assigned.ids + children_leads.ids))]
            ),
        ...
        self.assertEqual(
            ...
            repr(
                [("id", "in", sorted(children_leads[0:2].ids + children_leads_assigned[0:2].ids))]
            ),
    ...
    def test_partner_assign(self):
        ...
        self.assertEqual(
            lead.partner_assigned_id, partner_uk, "Opportuniy is not assigned nearest partner"
        )
        self.assertTrue(
        ...
        context = dict(
            self.env.context, default_model="crm.lead", default_res_id=lead.id, active_ids=lead.ids
        )
