...
class TestContractCalendars(TestContractCommon):
    ...
    def test_contract_state_incoming_to_open(self):
        ...
        self.assertEqual(
            ...
            self.contract_cdd.resource_calendar_id,
    ...
    def test_contract_transfer_leaves(self):
        ...
        self.assertEqual(
            leave1.calendar_id, self.calendar_richard, "It should stay in Richard's calendar"
        )
        self.assertEqual(
            leave3.calendar_id,
        ...
        self.assertEqual(
            leave2.calendar_id, self.calendar_35h, "It should be transfered to the other calendar"
        )
