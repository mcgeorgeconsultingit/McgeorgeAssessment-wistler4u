    ...
    def _populate_factories(self):
        ...
        address_factories_groups = [
            ...
            [  # other corner cases, 4 records
                (
                    "street",
                    populate.iterate(["万泉寺村", "საბჭოს სკვერი {counter}", "10th Street {counter}"]),
                ),
        ...
        return [
            ...
            (
                "mobile",
                populate.randomize([False, "", "+32412345678", "0032412345678", "412345678"]),
            ),
            ...
            (
                "tz",
                populate.randomize(
                    [tz for tz in self.env["res.partner"]._fields["tz"].get_values(self.env)]
                ),
            ),
    ...
    def _populate_factories(self):
        return [
            ...
            (
                "name",
                populate.cartesian(
                    [False, "Industry name", "Industry name {counter}"], [0.08, 0.01, 0.9]
                ),
            ),
