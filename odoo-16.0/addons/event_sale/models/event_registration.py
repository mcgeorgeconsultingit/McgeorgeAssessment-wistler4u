...
class EventRegistration(models.Model):
    ...
    utm_campaign_id = fields.Many2one(
        compute="_compute_utm_campaign_id", readonly=False, store=True, ondelete="set null"
    )
    utm_source_id = fields.Many2one(
        compute="_compute_utm_source_id", readonly=False, store=True, ondelete="set null"
    )
    utm_medium_id = fields.Many2one(
        compute="_compute_utm_medium_id", readonly=False, store=True, ondelete="set null"
    )
