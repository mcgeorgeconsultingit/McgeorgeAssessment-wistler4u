...
class TestSaleService(TestCommonSaleTimesheet):
    ...
    def test_sale_service(self):
        ...
        self.assertEqual(
            self.sale_order.invoice_status, "invoiced", "Sale Service: SO should be invoiced"
        )
        self.assertEqual(
            self.sale_order.tasks_count, 1, "A task should have been created on SO confirmation."
        )
    ...
    def test_timesheet_uom(self):
        ...
        self.assertEqual(
            sale_order_line.qty_delivered, 2, "Sale: uom conversion of timesheets is wrong"
        )
    ...
    def test_sale_create_task(self):
        ...
        self.assertTrue(
            so_line1.project_id, "SO confirmation should create a project and link it to SOL"
        )
        ...
        self.assertTrue(
            so_line1.project_id, "SO reconfirmation should bit have create another project"
        )
        self.assertEqual(self.sale_order.tasks_count, 1, "The SO should still have only one task")
        self.assertEqual(
            so_line1.task_id.sale_line_id,
    ...
    def test_sale_create_project(self):
        ...
        self.assertTrue(
            so_line1.project_id, "Line1 should have create a project based on template A"
        )
        self.assertTrue(so_line2.project_id, "Line2 should have create an empty project")
        self.assertEqual(
            so_line3.project_id, so_line1.project_id, "Line3 should reuse project of line1"
        )
        self.assertEqual(
            so_line4.project_id, so_line2.project_id, "Line4 should reuse project of line2"
        )
        self.assertTrue(
            so_line4.task_id, "Line4 should have create a new task, even if no project created."
        )
        self.assertTrue(
            so_line5.project_id, "Line5 should have create a project based on template B"
        )
        ...
        self.assertTrue(
            so_line1.project_id.allow_timesheets, "Create project should allow timesheets"
        )
        self.assertTrue(
            so_line2.project_id.allow_timesheets, "Create project should allow timesheets"
        )
        self.assertTrue(
            so_line5.project_id.allow_timesheets, "Create project should allow timesheets"
        )
    ...
    def test_sale_task_in_project_with_project(self):
        ...
        self.product_order_timesheet4.write({"project_template_id": self.project_template.id})
        self.sale_order.action_confirm()
    ...
    def test_sale_task_in_project_without_project(self):
        ...
        # temporary project_template_id for our checks
        self.product_order_timesheet3.write({"project_template_id": self.project_template.id})
        self.sale_order.action_confirm()
        # remove it after the confirm because other tests don't like it
    ...
    def test_copy_billable_project_and_task(self):
        ...
        self.assertFalse(
            project_copy.sale_order_id, "Duplicating project should erase its Sale order"
        )
        self.assertEqual(
            len(project.tasks),
        ...
        task_copy = task.copy()
        self.assertEqual(
            task_copy.sale_line_id, task.sale_line_id, "Duplicating task should keep its Sale line"
        )
    ...
    def test_remaining_hours_prepaid_services(self):
        ...
        self.assertEqual(
            prepaid_service_sol.remaining_hours, 2, "The remaining hours should not change."
        )
