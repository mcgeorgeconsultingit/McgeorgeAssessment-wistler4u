...
class StockQuant(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.stock_subloc3 = cls.env["stock.location"].create(
            {"name": "subloc3", "usage": "internal", "location_id": cls.stock_location.id}
        )
    ...
    def test_get_available_quantity_2(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 3.0
        )
    ...
    def test_increase_available_quantity_5(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, stock_sub_location), 1.0
        )
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(product2, self.stock_location), 2.0
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(product2, stock_sub_location), 1.0
        )
    ...
    def test_increase_reserved_quantity_3(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 29.0
        )
        self.assertEqual(len(self.gather_relevant(self.product, self.stock_location)), 4)
        self.env["stock.quant"]._update_reserved_quantity(self.product, self.stock_location, 10.0)
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 19.0
        )
        self.assertEqual(len(self.gather_relevant(self.product, self.stock_location)), 4)
    ...
    def test_action_done_1(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, pack_location), 2.0
        )
    ...
    def test_in_date_3(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.product_serial, self.stock_location, 1.0, lot_id=lot1, in_date=in_date_lot1
        )
        self.env["stock.quant"]._update_available_quantity(
            self.product_serial, self.stock_location, 1.0, lot_id=lot2, in_date=in_date_lot2
        )
