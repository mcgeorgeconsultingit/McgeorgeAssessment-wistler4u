...
class MailGroupMessage(models.Model):
    ...
    mail_message_id = fields.Many2one(
        "mail.message", "Mail Message", required=True, ondelete="cascade", index=True, copy=False
    )
    # Parent and children
    group_message_parent_id = fields.Many2one("mail.group.message", string="Parent", store=True)
