...
class StockMove(TransactionCase):
    ...
    def test_out_1(self):
        ...
        self.assertEqual(len(move1.move_line_ids), 1)
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 0.0
        )
    ...
    def test_mixed_tracking_reservation_2(self):
        ...
        self.assertEqual(
            len(self.gather_relevant(self.product_serial, self.stock_location, strict=True)), 1.0
        )  # with a qty of 2
        self.assertEqual(
            len(
    ...
    def test_putaway_with_storage_category_1(self):
        ...
        """
        # storage category
        storage_category = self.env["stock.storage.category"].create({"name": "storage category"})
    ...
    def test_availability_2(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 50.0
        )
        self.assertEqual(len(self.gather_relevant(self.product, self.stock_location)), 1.0)
    ...
    def test_availability_6(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 6.0
        )
        ...
        self.assertEqual(move.state, "confirmed")
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 8.0
        )
    ...
    def test_unreserve_3(self):
        ...
        self.assertEqual(len(self.gather_relevant(self.product, self.stock_location)), 1.0)
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 2
        )
        ...
        move1._do_unreserve()
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 2.0
        )
        self.assertEqual(len(quants), 1.0)
        self.assertEqual(quants.quantity, 2.0)
    ...
    def test_unreserve_5(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 5
        )
    ...
    def test_unreserve_6(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 10.0
        )
    ...
    def test_unreserve_7(self):
        ...
        self.assertEqual(len(move1.move_line_ids), 5)
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(product, self.stock_location), 0.0
        )
    ...
    def test_link_assign_3(self):
        ...
        move_pack_cust.write(
            {"move_orig_ids": [(4, move_stock_pack_1.id, 0), (4, move_stock_pack_2.id, 0)]}
        )
    ...
    def test_link_assign_5(self):
        ...
        move_stock_pack.write(
            {"move_dest_ids": [(4, move_pack_cust_1.id, 0), (4, move_pack_cust_2.id, 0)]}
        )
    ...
    def test_link_assign_6(self):
        ...
        move_stock_stock_1.write(
            {"move_orig_ids": [(4, move_supp_stock_1.id, 0), (4, move_supp_stock_2.id, 0)]}
        )
        ...
        (
            move_supp_stock_1 + move_supp_stock_2 + move_stock_stock_1 + move_stock_stock_2
        )._action_confirm()
    ...
    def test_use_unreserved_move_line_1(self):
        ...
        # reserve those move
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 1.0
        )
        move1._action_confirm()
        move1._action_assign()
        self.assertEqual(move1.state, "assigned")
    ...
    def test_edit_reserved_move_line_1(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, shelf1_location), 1.0
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, shelf2_location), 1.0
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 2.0
        )
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, shelf1_location), 0.0
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, shelf2_location), 1.0
        )
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, shelf2_location), 0.0
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 1.0
        )
    ...
    def test_edit_reserved_move_line_9(self):
        ...
        self.assertEqual(
            out_move.move_line_ids.reserved_uom_qty, 0, "The reserved quantity should be cancelled"
        )
    ...
    def test_edit_done_move_line_11(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 15.0
        )
    ...
    def test_edit_done_move_line_14(self):
        ...
        move1._action_done()
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 12.0
        )

        move1.move_line_ids.qty_done = 2
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 24.0
        )
    ...
    def test_immediate_validate_8(self):
        ...
        self.assertEqual(
            immediate_trans_wiz.immediate_transfer_line_ids.mapped("to_immediate"), [True, True]
        )
    ...
    def test_scrap_1(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 0
        )
    ...
    def test_scrap_4(self):
        ...
        self.assertEqual(
            scrap.scrap_qty, 5, "Scrap quantity has been modified and is not correct anymore."
        )
    ...
    def test_scrap_6(self):
        ...
        self.assertEqual(
            warning_message.get("res_model", "Wrong Model"), "stock.warn.insufficient.qty.scrap"
        )
        ...
        self.assertEqual(
            self.env["stock.quant"]._gather(self.product, self.stock_location).quantity, -11
        )
    ...
    def test_scrap_8(self):
        ...
        internal_operation = (
            ...
            .search([("code", "=", "internal"), ("company_id", "=", self.env.company.id)], limit=1)
        )
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(product01, self.stock_location), 1
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(product02, self.stock_location), 1
        )
    ...
    def test_edit_done_picking_1(self):
        ...
        self.assertEqual(
            len(picking.move_ids), 2, "The new move associated to the move line does not exist."
        )
        self.assertEqual(
        ...
        self.assertEqual(
            picking.state, "done", "Picking should still done after adding a new move line."
        )
        self.assertTrue(
            all(move.state == "done" for move in picking.move_ids), "Wrong state for move."
        )
    ...
    def test_put_in_pack_1(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.customer_location), 2
        )
    ...
    def test_put_in_pack_2(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(product1, self.stock_location), 0
        )
        picking.action_put_in_pack()
        self.assertEqual(len(picking.move_line_ids), 2)
        self.assertEqual(
    ...
    def test_move_line_aggregated_product_quantities_duplicate_stock_move(self):
        ...
        picking.button_validate()
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 10
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.customer_location),
            15,
    ...
    def test_move_line_aggregated_product_quantities_incomplete_package(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.stock_location), 20
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product, self.customer_location), 5
        )
    ...
    def test_SML_location_selection(self):
        ...
        self.env.user.write(
            {"groups_id": [(3, self.env.ref("stock.group_stock_storage_categories").id)]}
        )
        ...
        self.assertEqual(
            picking.move_line_ids_without_package.location_dest_id, self.stock_location.child_ids[0]
        )
