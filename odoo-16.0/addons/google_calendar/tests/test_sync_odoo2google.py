...
class TestSyncOdoo2Google(TestSyncGoogle):
        ...
        self.assertGoogleEventInserted(
            {
                ...
                "reminders": {
                    "useDefault": False,
                    "overrides": [{"method": "popup", "minutes": alarm.duration_minutes}],
                },
        ...
        self.assertGoogleEventInserted(
            {
                ...
                "recurrence": ["RRULE:FREQ=WEEKLY;COUNT=2;BYDAY=WE"],
                "extendedProperties": {
                    "shared": {"%s_odoo_id" % self.env.cr.dbname: event.recurrence_id.id}
                },
            },
            timeout=3,
        )
    ...
    def test_write_unsynced_field(self):
        ...
        event.write({"recurrence_update": "all_events", "categ_ids": [(4, event_type.id)]})
    ...
    def test_attendee_state(self):
        ...
        self.assertEqual(
            event.attendee_ids.state, "needsAction", "The attendee state should be 'needsAction"
        )
