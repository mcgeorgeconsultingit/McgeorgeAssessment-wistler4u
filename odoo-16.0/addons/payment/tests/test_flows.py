...
class TestFlows(PaymentHttpCommon):
    ...
    def test_transaction_wrong_token(self):
        ...
        self.assertIn(
            "odoo.exceptions.ValidationError: The access token is invalid.", response.text
        )
    ...
    def test_direct_payment_triggers_no_payment_request(self):
        ...
        with patch(
            ...
            self._portal_transaction(**self._prepare_transaction_values(self.provider.id, "direct"))
