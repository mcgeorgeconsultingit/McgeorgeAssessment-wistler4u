...
class TestPurchaseOrderReport(AccountTestInvoicingCommon):
    def test_00_purchase_order_report(self):
        ...
        self.assertEqual(
            res_product2.qty_ordered, 1.0, "No conversion needed since product_b is already a dozen"
        )
    ...
    def test_01_delay_and_delay_pass(self):
        ...
        self.assertEqual(
            round(report[0]["delay"]), -10, msg="The PO has been confirmed 10 days in advance"
        )
        self.assertEqual(
