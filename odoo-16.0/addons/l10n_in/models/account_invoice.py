...
class AccountMove(models.Model):
    ...
    l10n_in_shipping_port_code_id = fields.Many2one(
        "l10n_in.port.code", "Port code", readonly=True, states={"draft": [("readonly", False)]}
    )
    ...
    def _post(self, soft=True):
        ...
        gst_treatment_name_mapping = {
            k: v for k, v in self._fields["l10n_in_gst_treatment"]._description_selection(self.env)
        }
