...
class TestUi(TestUICommon):
    def test_course_member_employee(self):
        ...
        user_demo.write({"karma": 1, "groups_id": [(6, 0, self.env.ref("base.group_user").ids)]})
                ...
                "groups_id": [
                    (
                        ...
                        (
                            ...
                            | self.env.ref("website_slides.group_website_slides_officer")
                        ).ids,
                    )
                ],
            }
...
class TestUiPublisherYoutube(HttpCaseWithUserDemo):
    def test_course_member_yt_employee(self):
        ...
        user_demo = self.user_demo
        user_demo.write({"groups_id": [(5, 0), (4, self.env.ref("base.group_user").id)]})
