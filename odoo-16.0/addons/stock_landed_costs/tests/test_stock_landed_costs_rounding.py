...
class TestStockLandedCostsRounding(TestStockLandedCostsCommon):
    def test_stock_landed_costs_rounding(self):
        ...
        product_landed_cost_3.product_tmpl_id.categ_id.property_stock_account_input_categ_id = (
            self.company_data["default_account_expense"]
        )
        product_landed_cost_3.product_tmpl_id.categ_id.property_stock_account_output_categ_id = (
        ...
        product_landed_cost_4.product_tmpl_id.categ_id.property_stock_account_input_categ_id = (
            self.company_data["default_account_expense"]
        )
        product_landed_cost_4.product_tmpl_id.categ_id.property_stock_account_output_categ_id = (
            self.company_data["default_account_revenue"]
        )
