...
class Employee(models.AbstractModel):
    ...
    def _compute_presence_state(self):
        ...
        employee_to_check_working = employees.filtered(
            lambda e: not e.is_absent and (e.email_sent or e.ip_connected or e.manually_set_present)
        )
        ...
        for employee in employees:
            if (
                ...
                and (employee.email_sent or employee.ip_connected or employee.manually_set_present)
            ):
    ...
    def _check_presence(self):
        ...
        if (
            ...
            self.env["hr.employee"].search([("company_id", "=", company.id)]).write(
                {"email_sent": False, "ip_connected": False, "manually_set_present": False}
            )
