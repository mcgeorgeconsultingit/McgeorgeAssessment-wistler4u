        ...
        self._run_test(
            {
                ...
                "orders": [
                    {
                        "pos_order_lines_ui_args": [],
                        "payments": [(self.bank_split_pm1, 100), (self.pay_later_pm, -100)],
                        "customer": self.customer,
                        "is_invoiced": False,
                        "uid": "00100-010-0001",
                    },
        ...
        self._run_test(
            {
                ...
                "orders": [
                    {
                        "pos_order_lines_ui_args": [],
                        "payments": [(self.cash_split_pm1, 100), (self.pay_later_pm, -100)],
                        "customer": self.customer,
                        "is_invoiced": False,
                        "uid": "00100-010-0001",
                    },
        ...
        self._run_test(
            {
                ...
                "orders": [
                    {
                        "pos_order_lines_ui_args": [(self.product100, 1)],
                        "payments": [(self.cash_split_pm1, 200), (self.pay_later_pm, -100)],
                        "customer": self.customer,
                        "is_invoiced": False,
                        "uid": "00100-010-0001",
                    },
        ...
        self._run_test(
            {
                ...
                "orders": [
                    {
                        "pos_order_lines_ui_args": [(self.product100, 1)],
                        "payments": [(self.bank_split_pm1, 200), (self.pay_later_pm, -100)],
                        "customer": self.customer,
                        "is_invoiced": False,
                        "uid": "00100-010-0001",
                    },
        ...
        self._run_test(
            {
                ...
                "orders": [
                    {
                        "pos_order_lines_ui_args": [(self.product100, 1)],
                        "payments": [(self.cash_split_pm1, 200), (self.cash_split_pm1, -100)],
                        "customer": self.customer,
                        "is_invoiced": False,
                        "uid": "00100-010-0001",
                    },
        ...
        self._run_test(
            {
                ...
                "orders": [
                    {
                        "pos_order_lines_ui_args": [(self.product100, 1)],
                        "payments": [(self.bank_split_pm1, 50), (self.pay_later_pm, 50)],
                        "customer": self.customer,
                        "is_invoiced": False,
                        "uid": "00100-010-0001",
                    },
        ...
        self._run_test(
            {
                ...
                "orders": [
                    {
                        "pos_order_lines_ui_args": [(self.product100, 1)],
                        "payments": [(self.cash_split_pm1, 50), (self.pay_later_pm, 50)],
                        "customer": self.customer,
                        "is_invoiced": False,
                        "uid": "00100-010-0001",
                    },
