...
class TestFormatLangDate(TransactionCase):
    ...
    def test_01_code_and_format(self):
        ...
        self.assertEqual(
            misc.format_date(lang.with_context(lang="fr_FR").env, date_str), "31/01/2017"
        )
        ...
        # Change 2 parameters
        self.assertEqual(
            misc.format_date(lang.with_context(lang="zh_CN").env, date_str, lang_code="fr_FR"),
            "31/01/2017",
        )
        self.assertEqual(
            misc.format_date(lang.with_context(lang="zh_CN").env, date_str, date_format="MMM d, y"),
            "1\u6708 31, 2017",
        )
        self.assertEqual(
            misc.format_date(lang.env, date_str, lang_code="fr_FR", date_format="MMM d, y"),
            "janv. 31, 2017",
        )
        ...
        self.assertEqual(
            misc.format_datetime(
                lang.env, datetime_str, tz="Europe/Brussels", dt_format="long", lang_code="fr_FR"
            ),
        ...
        self.assertEqual(
            misc.format_time(lang.with_context(lang="zh_CN").env, time_part), "\u4e0b\u53484:30:22"
        )

        # Check format in different languages
        self.assertEqual(
            misc.format_time(lang.with_context(lang="fr_FR").env, time_part, time_format="short"),
            "16:30",
        )
        self.assertEqual(
            misc.format_time(lang.with_context(lang="zh_CN").env, time_part, time_format="short"),
            "\u4e0b\u53484:30",
        )

        # Check timezoned time part
        self.assertIn(
            misc.format_time(lang.with_context(lang="fr_FR").env, time_part_tz, time_format="long"),
            ["16:30:22 -0504", "16:30:22 HNE"],
        )
        self.assertEqual(
            misc.format_time(lang.with_context(lang="zh_CN").env, time_part_tz, time_format="full"),
            "\u5317\u7f8e\u4e1c\u90e8\u6807\u51c6\u65f6\u95f4\u0020\u4e0b\u53484:30:22",
        )
        ...
        self.assertEqual(
            misc.format_time(
                lang.with_context(lang="fr_FR").env, datetime_str, "US/Eastern", time_format="long"
            ),
            "05:33:00 HNE",
        )
