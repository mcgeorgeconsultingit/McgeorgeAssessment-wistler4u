...
class ResourceMixin(models.AbstractModel):
    ...
    def create(self, vals_list):
        resources_vals_list = []
        calendar_ids = [
            vals["resource_calendar_id"] for vals in vals_list if vals.get("resource_calendar_id")
        ]
        calendars_tz = {
    ...
    def list_leaves(self, from_datetime, to_datetime, calendar=None, domain=None):
        ...
        attendances = calendar._attendance_intervals_batch(from_datetime, to_datetime, resource)[
            resource.id
        ]
        leaves = calendar._leave_intervals_batch(from_datetime, to_datetime, resource, domain)[
            resource.id
        ]
        result = []
