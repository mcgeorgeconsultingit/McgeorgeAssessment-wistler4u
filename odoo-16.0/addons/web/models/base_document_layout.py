...
class BaseDocumentLayout(models.TransientModel):
    ...
    report_footer = fields.Html(
        related="company_id.report_footer", readonly=False, default=_default_report_footer
    )
    company_details = fields.Html(
        related="company_id.company_details", readonly=False, default=_default_company_details
    )
    ...
    def extract_image_primary_secondary_colors(self, logo, white_threshold=225, mitigate=175):
        ...
        secondary = (
            tools.average_dominant_color(remaining, mitigate=mitigate)[0] if remaining else primary
        )
