...
class TestRelatedTranslation(odoo.tests.TransactionCase):
    ...
    def test_translate_from_ori_term(self):
        self.assertEqual(
            self.test1.with_context(lang="en_US").html, "<p>Knife</p><p>Fork</p><p>Spoon</p>"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            self.test2.with_context(lang="en_US").html, "<p>Knife</p><p>Fork</p><p>Spoon</p>"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            self.test3.with_context(lang="en_US").html, "<p>Knife</p><p>Fork</p><p>Spoon</p>"
        )
        self.assertEqual(
    ...
    def test_translate_change_many2one(self):
        ...
        self.assertEqual(
            self.test3.with_context(lang="en_US").html, "<p>Knife 2</p><p>Fork 2</p><p>Spoon 2</p>"
        )
        self.assertEqual(
            self.test3.with_context(lang="fr_FR").html,
