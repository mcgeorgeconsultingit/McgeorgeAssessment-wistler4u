...
class Company(models.Model):
    ...
    l10n_ch_isr_preprinted_account = fields.Boolean(
        string="Preprinted account", compute="_compute_l10n_ch_isr", inverse="_set_l10n_ch_isr"
    )
    l10n_ch_isr_preprinted_bank = fields.Boolean(
        string="Preprinted bank", compute="_compute_l10n_ch_isr", inverse="_set_l10n_ch_isr"
    )
