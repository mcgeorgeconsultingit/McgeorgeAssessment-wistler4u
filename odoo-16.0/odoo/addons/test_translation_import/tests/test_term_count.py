...
class TestImport(common.TransactionCase):
    def test_import_code_translation(self):
        ...
        self.assertEqual(model.with_context(lang="fr_FR").get_code_translation(), "Code, Français")
    ...
    def test_lang_with_base(self):
        ...
        record = self.env.ref("test_translation_import.test_translation_import_model1_record1")
        self.assertEqual(
            record.with_context(lang="fr_BE").get_code_translation(), "Code, Français, Belgium"
        )
        ...
        self.assertEqual(record.with_context(lang="fr_CA").get_code_translation(), "Code, Français")
    ...
    def test_import_from_po_file(self):
        ...
        record = self.env.ref("test_translation_import.test_translation_import_model1_record1")
        self.assertEqual(record.with_context(lang="tlh").get_code_translation(), "Code, Klingon")
    ...
    def test_lazy_translation(self):
        ...
        self.assertEqual(
            str(TRANSLATED_TERM), "Code Lazy, English", "The translation should not be applied yet"
        )

        context = {"lang": "tlh"}
        self.assertEqual(
            str(TRANSLATED_TERM), "Code Lazy, Klingon", "The lazy code translation was not applied"
        )
    ...
    def test_import_from_csv_file(self):
        ...
        record = self.env.ref("test_translation_import.test_translation_import_model1_record1")
        self.assertEqual(record.with_context(lang="dot").get_code_translation(), "Code, English")
...
class TestTranslationFlow(common.TransactionCase):
    def test_export_import(self):
        ...
        self.assertEqual(
            old_python, new_python, "python code translations are not exported/imported correctly"
        )
        ...
        self.assertEqual(
            old_web, new_web, "web client code translations are not exported/imported correctly"
        )
