...
class TestLifoPrice(ValuationReconciliationTestCommon):
    def test_lifoprice(self):
        ...
        product_form.categ_id.property_stock_account_output_categ_id = self.company_data[
        ...
        purchase_order_lifo1.picking_ids[
            0
        ].move_ids.quantity_done = purchase_order_lifo1.picking_ids[0].move_ids.product_qty
        ...
        purchase_order_lifo2.picking_ids[
            0
        ].move_ids.quantity_done = purchase_order_lifo2.picking_ids[0].move_ids.product_qty
