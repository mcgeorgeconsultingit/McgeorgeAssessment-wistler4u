...
class IrModelAccessTest(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.public_user = new_test_user(cls.env, login="publicDude", groups="base.group_public")
    ...
    def test_display_name_for(self):
        ...
        result = (
            self.env["ir.model"].with_user(self.spreadsheet_user).display_name_for(["res.company"])
        )
