...
class ReportProjectTaskUser(models.Model):
    ...
    working_days_close = fields.Float(
        string="Working Days to Close", digits=(16, 2), readonly=True, group_operator="avg"
    )
    working_days_open = fields.Float(
        string="Working Days to Assign", digits=(16, 2), readonly=True, group_operator="avg"
    )
    ...
    working_hours_open = fields.Float(
        string="Working Hours to Assign", digits=(16, 2), readonly=True, group_operator="avg"
    )
    working_hours_close = fields.Float(
        string="Working Hours to Close", digits=(16, 2), readonly=True, group_operator="avg"
    )
    ...
    rating_avg = fields.Float(
        "Average Rating", readonly=True, group_operator="avg", groups="project.group_project_rating"
    )
    priority = fields.Selection([("0", "Low"), ("1", "High")], readonly=True, string="Priority")
    ...
    is_closed = fields.Boolean(
        "Closing Stage", readonly=True, help="Folded in Kanban stages are closing stages."
    )
