...
class DisplayDriver(Driver):
    ...
    def update_url(self, url=None):
        ...
        new_window = subprocess.call(
            ["xdotool", "search", "--onlyvisible", "--screen", self._x_screen, "--class", "Firefox"]
        )
...
class DisplayController(http.Controller):
    ...
    @http.route(
        [
            ...
            "/point_of_sale/get_serialized_order/<string:display_identifier>",
        ],
        type="json",
        auth="none",
    )
