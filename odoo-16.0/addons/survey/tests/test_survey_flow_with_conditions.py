    ...
    def test_conditional_flow_with_scoring(self):
        with self.with_user("survey_user"):
            ...
            q02 = self._add_question(
                ...
                triggering_answer_id=q01.suggested_answer_ids.filtered(lambda q: q.is_correct).id,
                labels=[
                    {"value": "Answer 1"},
            ...
            self._add_question(  # q04
                ...
                triggering_answer_id=q03.suggested_answer_ids.filtered(lambda q: q.is_correct).id,
                labels=[
                    {"value": "Answer 1"},
                    {"value": "Answer 2", "is_correct": True, "answer_score": 1.0},
                    {"value": "Answer 3"},
            ...
            q06 = self._add_question(
                ...
                triggering_answer_id=q05.suggested_answer_ids.filtered(lambda q: q.is_correct).id,
                labels=[
                    {"value": "Answer 1"},
                    {"value": "Answer 2", "is_correct": True, "answer_score": 1.0},
                    {"value": "Answer 3"},
