...
class account_journal(models.Model):
    ...
    def get_bar_graph_datas(self):
        ...
        for index in range(0, len(query_results)):
            if query_results[index].get("aggr_date") != None:
                ...
                week_index = next(
                    i for i in range(0, len(weeks)) if weeks[i][0] <= aggr_date < weeks[i][1]
                )
    ...
    def get_journal_dashboard_datas(self):
        ...
        if self.type in ("bank", "cash"):
            ...
            ) = self._get_journal_bank_account_balance(domain=[("parent_state", "=", "posted")])
            (
        ...
        return {
            ...
            "outstanding_pay_account_balance": formatLang(
                self.env, currency.round(outstanding_pay_account_balance), currency_obj=currency
            ),
    ...
    def open_action(self):
        ...
        domain_type_field = (
            action["res_model"] == "account.move.line" and "move_id.move_type" or "move_type"
