...
class TestHrHolidaysCommon(common.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.user_hruser = mail_new_test_user(
            cls.env, login="armande", groups="base.group_user,hr_holidays.group_hr_holidays_user"
        )
        cls.user_hruser_id = cls.user_hruser.id

        cls.user_hrmanager = mail_new_test_user(
            cls.env, login="bastien", groups="base.group_user,hr_holidays.group_hr_holidays_manager"
        )
