...
class AccountMoveLine(models.Model):
    ...
    def init(self):
        tools.create_index(
            self._cr, "account_move_line_move_product_index", self._table, ["move_id", "product_id"]
        )
...
class AccountTax(models.Model):
    ...
    l10n_in_reverse_charge = fields.Boolean(
        "Reverse charge", help="Tick this if this tax is reverse charge. Only for Indian accounting"
    )
