...
class ResConfigSettings(models.TransientModel):
    ...
    external_email_server_default = fields.Boolean(
        "Custom Email Servers", config_parameter="base_setup.default_external_email_server"
    )
    ...
    def _compute_company_informations(self):
        ...
        informations += (
            "%s" % self.company_id.country_id.display_name if self.company_id.country_id else ""
        )
