...
class TestActionBindings(common.TransactionCase):
    def test_bindings(self):
        ...
        action1.binding_model_id = action2.binding_model_id = action3.binding_model_id = self.env[
            "ir.model"
        ]._get("res.partner")
...
class TestBindingViewFilters(common.TransactionCase):
    def test_act_window(self):
        ...
        form_act = A.get_views([(False, "form")], {"toolbar": True})["views"]["form"]["toolbar"][
            "action"
        ]
        self.assertEqual(
        ...
        list_act = A.get_views([(False, "list")], {"toolbar": True})["views"]["list"]["toolbar"][
            "action"
        ]
        self.assertEqual(
        ...
        kanban_act = A.get_views([(False, "kanban")], {"toolbar": True})["views"]["kanban"][
            "toolbar"
        ]["action"]
        self.assertEqual(
    ...
    def test_act_record(self):
        ...
        form_act = B.get_views([(False, "form")], {"toolbar": True})["views"]["form"]["toolbar"][
            "action"
        ]
        self.assertEqual(
            [a["name"] for a in form_act],
        ...
        list_act = B.get_views([(False, "list")], {"toolbar": True})["views"]["list"]["toolbar"][
            "action"
        ]
        self.assertEqual(
            [a["name"] for a in list_act],
        ...
        kanban_act = B.get_views([(False, "kanban")], {"toolbar": True})["views"]["kanban"][
            "toolbar"
        ]["action"]
        self.assertEqual(
            [a["name"] for a in kanban_act],
