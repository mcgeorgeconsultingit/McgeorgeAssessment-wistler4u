...
class Pricelist(models.Model):
    ...
    def _get_product_price(self, product, quantity, uom=None, date=False, **kwargs):
        ...
        """
        self.ensure_one()
        return self._compute_price_rule(product, quantity, uom=uom, date=date, **kwargs)[
            product.id
        ][0]
    ...
    def _get_applicable_rules(self, products, date, **kwargs):
        ...
        return (
            ...
            .search(self._get_applicable_rules_domain(products=products, date=date, **kwargs))
        )
    ...
    def _get_partner_pricelist_multi(self, partner_ids):
        ...
        if remaining_partner_ids:
            ...
            for group in groups:
                ...
                pl = Pricelist.search(
                    pl_domain + [("country_group_ids.country_ids", "=", country_id)], limit=1
                )
