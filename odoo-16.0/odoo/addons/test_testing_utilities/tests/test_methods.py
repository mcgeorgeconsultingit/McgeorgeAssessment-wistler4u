...
class TestBasic(common.TransactionCase):
    ...
    def test_assertRaises_error(self):
        ...
        with mock.patch.object(BaseCursor, "flush", side_effect=CustomError), TestCase.assertRaises(
            self, CustomError
        ):
            with self.assertRaises(CustomError):
    ...
    def test_assertRaises_clear_recovery(self):
        ...
        with mock.patch.object(BaseCursor, "clear", side_effect=clear), TestCase.assertRaises(
            self, psycopg2.Error
        ):
