    ...
    * Official doc for EHF Billing 3.0 is the OpenPeppol BIS 3 doc +
    ...
    def _invoice_constraints_cen_en16931_ubl(self, invoice, vals):
        ...
        constraints = {
            ...
            if vals["vals"]["payment_means_vals_list"][0]["payment_means_code"] in (30, 58)
            else None,
            ...
            "cen_en16931_seller_EAS": self._check_required_fields(
                vals["vals"]["accounting_supplier_party_vals"]["party_vals"]["endpoint_id_attrs"],
                "schemeID",
                _(
            ...
            "cen_en16931_buyer_EAS": self._check_required_fields(
                vals["vals"]["accounting_customer_party_vals"]["party_vals"]["endpoint_id_attrs"],
                "schemeID",
                _(
                    "No Electronic Address Scheme (EAS) could be found for %s.",
                    vals["customer"].name,
    ...
    def _invoice_constraints_peppol_en16931_ubl(self, invoice, vals):
        ...
        constraints = {
            ...
            and self._check_required_fields(invoice, "invoice_origin")
            else None,
        }
