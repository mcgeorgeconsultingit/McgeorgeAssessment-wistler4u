...
class SlidePartnerRelation(models.Model):
    ...
    def _compute_survey_scoring_success(self):
        succeeded_user_inputs = (
            ...
            .sudo()
            .search([("slide_partner_id", "in", self.ids), ("scoring_success", "=", True)])
        )
...
class Slide(models.Model):
    ...
    slide_type = fields.Selection(
        selection_add=[("certification", "Certification")], ondelete={"certification": "set null"}
    )
            ...
            if slide.channel_id.is_member:
                ...
                if user_membership_id_sudo.user_input_ids:
                    ...
                    user_input = slide.survey_id.sudo()._create_answer(
                        ...
                        **{"slide_id": slide.id, "slide_partner_id": user_membership_id_sudo.id},
