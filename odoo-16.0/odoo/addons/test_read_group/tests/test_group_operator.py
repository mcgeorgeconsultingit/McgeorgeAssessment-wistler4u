...
class TestGroupBooleans(common.TransactionCase):
    ...
    def test_agg_and(self):
        ...
        self.assertEqual(
            [
                {"key_count": 2, "__domain": [("key", "=", 1)], "key": 1, "bool_and": True},
                {"key_count": 2, "__domain": [("key", "=", 2)], "key": 2, "bool_and": False},
                {"key_count": 2, "__domain": [("key", "=", 3)], "key": 3, "bool_and": False},
            ],
            groups,
        )
    ...
    def test_agg_or(self):
        ...
        self.assertEqual(
            [
                {"key_count": 2, "__domain": [("key", "=", 1)], "key": 1, "bool_or": True},
                {"key_count": 2, "__domain": [("key", "=", 2)], "key": 2, "bool_or": True},
                {"key_count": 2, "__domain": [("key", "=", 3)], "key": 3, "bool_or": False},
            ],
            groups,
        )
