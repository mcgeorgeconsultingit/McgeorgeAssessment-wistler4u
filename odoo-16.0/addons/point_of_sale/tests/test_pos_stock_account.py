...
class TestPoSStock(TestPoSCommon):
    ...
    def test_01_orders_no_invoiced(self):
        ...
        def _before_closing_cb():
            ...
            self.assertAlmostEqual(
                orders_total, 1010.0, msg="The orders's total amount should equal the computed."
            )
            ...
            for order in self.pos_session.order_ids:
                ...
                self.assertTrue(
                    all(state == "done" for state in order.picking_ids[0].move_ids.mapped("state")),
        ...
        self._run_test(
            {
                ...
                "orders": [
                    {
                        "pos_order_lines_ui_args": [(self.product1, 10), (self.product2, 10)],
                        "uid": "00100-010-0001",
                    },
                    {
                        "pos_order_lines_ui_args": [(self.product2, 7), (self.product3, 7)],
                        "uid": "00100-010-0002",
                    },
                    {
    ...
    def test_03_order_product_w_owner(self):
        ...
        for order in self.pos_session.order_ids:
            ...
            self.assertTrue(
                self.partner_a == order.picking_ids[0].move_ids[0].move_line_ids[0].owner_id,
