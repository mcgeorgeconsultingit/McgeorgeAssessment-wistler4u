...
class TestMultistepManufacturingWarehouse(TestMrpCommon):
    ...
    def _check_location_and_routes(self):
        ...
        self.assertTrue(
            self.warehouse.manufacture_pull_id.active, self.warehouse.manufacture_to_resupply
        )
    ...
    def test_00_create_warehouse(self):
        ...
        self.assertEqual(
            self.warehouse.manufacture_pull_id.location_dest_id.id, self.warehouse.lot_stock_id.id
        )
    ...
    def test_02_warehouse_twostep_manufacturing(self):
        ...
        self.assertEqual(
            self.warehouse.manufacture_pull_id.location_dest_id.id, self.warehouse.sam_loc_id.id
        )
    ...
    def test_manufacturing_flow(self):
        ...
        self.assertEqual(
            production_order.origin, "SOURCEDOCUMENT", "The MO origin should be the SO name"
        )
        self.assertNotEqual(
    ...
    def test_manufacturing_3_steps_flexible(self):
        ...
        with Form(self.warehouse) as warehouse:
            warehouse.manufacture_steps = "pbm_sam"
        bom = self.env["mrp.bom"].search([("product_id", "=", self.finished_product.id)])
    ...
    def test_3_steps_and_byproduct(self):
        ...
        preprod_picking = (
            pickings[0] if pickings[0].location_id == warehouse_stock_location else pickings[1]
        )
    ...
    def test_2_steps_and_additional_moves(self):
        ...
        self.assertEqual(
            self.bom.bom_line_ids.product_id + self.product_2, mo.picking_ids.move_ids.product_id
        )
