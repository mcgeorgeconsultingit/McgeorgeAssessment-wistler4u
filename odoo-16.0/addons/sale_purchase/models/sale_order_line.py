...
class SaleOrderLine(models.Model):
    ...
    def _compute_purchase_count(self):
        database_data = (
            ...
            .sudo()
            .read_group([("sale_line_id", "in", self.ids)], ["sale_line_id"], ["sale_line_id"])
        )
        mapped_data = dict(
    ...
    def _purchase_increase_ordered_qty(self, new_qty, origin_values):
        ...
        for line in self:
            ...
            if last_purchase_line.state in [
                ...
                quantity = line.product_uom._compute_quantity(
                    new_qty - origin_values.get(line.id, 0.0), last_purchase_line.product_uom
                )
    ...
    def _purchase_service_create(self, quantity=False):
        ...
        for line in self:
            ...
            if not purchase_order:
                ...
                purchase_order = PurchaseOrder.with_context(mail_create_nosubscribe=True).create(
                    values
                )
