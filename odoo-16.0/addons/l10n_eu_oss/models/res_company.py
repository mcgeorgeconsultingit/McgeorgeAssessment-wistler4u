...
class Company(models.Model):
    ...
    def _get_repartition_lines_oss(self):
        ...
        defaults = (
            ...
            .with_company(self)
            .default_get(["invoice_repartition_line_ids", "refund_repartition_line_ids"])
        )
        ...
        for doc_type in "invoice", "refund":
            ...
            if oss_tags:
                defaults[f"{doc_type}_repartition_line_ids"][base_line][vals]["tag_ids"] += [
                    Command.link(tag.id) for tag in oss_tags[f"{doc_type}_base_tag"]
                ]
                defaults[f"{doc_type}_repartition_line_ids"][tax_line][vals]["tag_ids"] += [
