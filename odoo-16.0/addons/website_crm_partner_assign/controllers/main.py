        ...
        return request.render(
            "website_crm_partner_assign.portal_my_opportunity",
            {
                ...
                "stages": request.env["crm.stage"].search(
                    [("is_won", "!=", True)], order="sequence desc, name desc, id desc"
                ),
                "activity_types": request.env["mail.activity.type"]
                .sudo()
                .search(["|", ("res_model", "=", opp._name), ("res_model", "=", False)]),
...
class WebsiteCrmPartnerAssign(WebsitePartnerPage):
    ...
    def partners(self, country=None, grade=None, page=0, **post):
        ...
        grades = partner_obj.sudo().read_group(grade_domain, ["id", "grade_id"], groupby="grade_id")
        ...
        countries = partner_obj.sudo().read_group(
            country_domain, ["id", "country_id"], groupby="country_id", orderby="country_id"
        )
