...
class PosOrderLine(models.Model):
    ...
    is_reward_line = fields.Boolean(help="Whether this line is part of a reward or not.")
    ...
    coupon_id = fields.Many2one(
        "loyalty.card", "Coupon", ondelete="restrict", help="The coupon used to claim that reward."
    )
