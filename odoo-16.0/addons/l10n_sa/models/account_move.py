...
class AccountMove(models.Model):
    ...
    def _compute_show_delivery_date(self):
        for move in self:
            move.l10n_sa_show_delivery_date = move.country_code == "SA" and move.move_type in (
                "out_invoice",
                "out_refund",
            )
    ...
    def _compute_qr_code_str(self):
        ...
        def get_qr_encoding(tag, field):
            ...
            return (
                company_name_tag_encoding + company_name_length_encoding + company_name_byte_array
            )
        ...
        for record in self:
            ...
            if record.l10n_sa_confirmation_datetime and record.company_id.vat:
                ...
                time_sa = fields.Datetime.context_timestamp(
                    self.with_context(tz="Asia/Riyadh"), record.l10n_sa_confirmation_datetime
                )
