...
class XlsxCreatorCase(common.HttpCase):
    ...
    def setUp(self):
        ...
        self.default_params = {
            "domain": [],
            "fields": [
                {"name": field.name, "label": field.string} for field in self.model._fields.values()
            ],
            "groupby": [],
            "ids": False,
            "import_compat": False,
    ...
    def assertExportEqual(self, value, expected):
        for row in range(len(expected)):
            for column in range(len(expected[row])):
                ...
                self.assertEqual(
                    cell_value, expected_value, "Cell %s, %s have a wrong value" % (row, column)
                )
...
class TestGroupedExport(XlsxCreatorCase):
    ...
    def test_int_sum_max(self):
        ...
        export = self.export(
            values, fields=["int_sum", "int_max"], params={"groupby": ["int_sum", "int_max"]}
        )
    ...
    def test_float_min(self):
        ...
        export = self.export(
            values, fields=["int_sum", "float_min"], params={"groupby": ["int_sum", "float_min"]}
        )
    ...
    def test_float_avg(self):
        ...
        export = self.export(
            values, fields=["int_sum", "float_avg"], params={"groupby": ["int_sum", "float_avg"]}
        )
    ...
    def test_bool_and(self):
        ...
        export = self.export(
            values, fields=["int_sum", "bool_and"], params={"groupby": ["int_sum", "bool_and"]}
        )
    ...
    def test_bool_or(self):
        ...
        export = self.export(
            values, fields=["int_sum", "bool_or"], params={"groupby": ["int_sum", "bool_or"]}
        )
    ...
    def test_many2one(self):
        ...
        export = self.export(
            values, fields=["int_sum", "many2one"], params={"groupby": ["int_sum", "many2one"]}
        )
