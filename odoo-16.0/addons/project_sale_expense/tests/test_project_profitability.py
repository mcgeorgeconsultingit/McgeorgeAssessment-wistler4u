...
class TestProjectSaleExpenseProfitability(
    TestProjectProfitabilityCommon, TestProjectHrExpenseProfitabilityCommon, TestSaleCommon
):
    def test_project_profitability(self):
        ...
        expense_sheet = (
            self.check_project_profitability_before_creating_and_approving_expense_sheet(
