...
class TestSurveyInternals(common.TestSurveyCommon):
    ...
    def test_answer_validation_numerical(self):
        ...
        self.assertEqual(question.validate_question("2.0"), {question.id: "ValidationError"})

        self.assertEqual(question.validate_question("4.0"), {question.id: "ValidationError"})
    ...
    def test_answer_validation_char_box_length(self):
        ...
        self.assertEqual(
            question.validate_question("waytoomuchlonganswer"), {question.id: "ValidationError"}
        )
    ...
    def test_copy_conditional_question_settings(self):
        ...
        self.assertEqual(
            q_food_vegetarian_cloned.triggering_question_id.id, q_is_vegetarian_cloned.id
        )
        self.assertEqual(
        ...
        # Correct conditional layout
        self.assertEqual(
            q_food_not_vegetarian_cloned.triggering_question_id.id, q_is_vegetarian_cloned.id
        )
        self.assertEqual(
