...
class IrHttp(models.AbstractModel):
    ...
    def _match(cls, path):
        ...
        if not url_lang_str and request.lang == default_lang:
            _logger.debug(
                "%r (lang: %r) no lang in url and default website, continue", path, request_url_code
            )
        ...
        # See /8, homepage with trailing slash. /fr_BE/ -> /fr_BE
            ...
            _logger.debug(
                "%r (lang: %r) homepage with trailing slash, redirect", path, request_url_code
            )
        ...
        # See /9, valid lang in url
            ...
            _logger.debug(
                "%r (lang: %r) valid lang in url, rewrite url and continue", path, request_url_code
            )
