...
class TestWebsiteSaleComparison(odoo.tests.TransactionCase):
    def test_01_website_sale_comparison_remove(self):
        ...
        self.assertEqual(
            Website1.viewref("website_sale_comparison.product_attributes_body").website_id.id, 1
        )
        ...
        self.assertFalse(
            Website0.viewref(
                "website_sale_comparison.product_attributes_body", raise_if_not_found=False
            )
        )
