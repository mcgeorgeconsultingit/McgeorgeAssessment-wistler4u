    ...
    def notification(self):
        ...
        if payment_method:
            ...
            if data["SaleToPOIResponse"].get("DiagnosisResponse"):
                payment_method.adyen_latest_diagnosis = data["SaleToPOIResponse"]["MessageHeader"][
                    "ServiceID"
                ]
            else:
            ...
            _logger.error(
                "received a message for a terminal not registered in Odoo: %s", terminal_identifier
            )
