...
class ChatbotMailMessage(models.Model):
    ...
    mail_message_id = fields.Many2one(
        "mail.message", string="Related Mail Message", required=True, ondelete="cascade"
    )
    mail_channel_id = fields.Many2one(
        "mail.channel", string="Discussion Channel", required=True, ondelete="cascade"
    )
