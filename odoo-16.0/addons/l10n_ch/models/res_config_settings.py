...
class ResConfigSettings(models.TransientModel):
    ...
    l10n_ch_isr_preprinted_bank = fields.Boolean(
        string="Preprinted bank", related="company_id.l10n_ch_isr_preprinted_bank", readonly=False
    )
    ...
    l10n_ch_isr_scan_line_left = fields.Float(
        string="Horizontal offset", related="company_id.l10n_ch_isr_scan_line_left", readonly=False
    )
    l10n_ch_isr_scan_line_top = fields.Float(
        string="Vertical offset", related="company_id.l10n_ch_isr_scan_line_top", readonly=False
    )
