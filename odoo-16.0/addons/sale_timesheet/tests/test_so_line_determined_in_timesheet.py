...
class TestSoLineDeterminedInTimesheet(TestCommonSaleTimesheet):
    def test_sol_determined_when_project_is_task_rate(self):
        ...
        self.assertEqual(
            self.so.order_line[-1].qty_delivered, 2, "The quantity delivered should be equal to 2."
        )
        self.assertEqual(
    ...
    def test_sol_determined_when_project_is_project_rate(self):
        ...
        self.assertEqual(
            self.so.order_line[0].qty_delivered, 1, "The quantity delivered should be equal to 1."
        )
    ...
    def test_sol_determined_when_project_is_employee_rate(self):
        ...
        self.assertTrue(
            employee_user_timesheet.so_line == mapping.sale_line_id == self.so.order_line[-1],
