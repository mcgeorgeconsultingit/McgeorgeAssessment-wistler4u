...
class Employee(models.Model):
    ...
    employee_cars_count = fields.Integer(
        compute="_compute_employee_cars_count", string="Cars", groups="fleet.fleet_group_manager"
    )
    ...
    def action_open_employee_cars(self):
        ...
        return {
            ...
            "views": [
                [
                    self.env.ref("hr_fleet.fleet_vehicle_assignation_log_employee_view_list").id,
                    "tree",
                ],
                [False, "form"],
            ],
