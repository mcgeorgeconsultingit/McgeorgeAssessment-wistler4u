...
class MailMessageSubtype(models.Model):
    ...
    res_model = fields.Char(
        "Model", help="Model the subtype applies to. If False, this subtype applies to all models."
    )
    ...
    track_recipients = fields.Boolean(
        "Track Recipients", help="Whether to display all the recipients or only the important ones."
    )
