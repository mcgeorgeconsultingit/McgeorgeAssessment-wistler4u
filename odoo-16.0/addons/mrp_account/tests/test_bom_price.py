...
class TestBomPrice(TestBomPriceCommon):
    def test_00_compute_price(self):
        ...
        self.assertEqual(
            self.dining_table.standard_price, 1000, "Initial price of the Product should be 1000"
        )
    ...
    def test_01_compute_price_operation_cost(self):
        ...
        self.assertEqual(
            float_compare(self.dining_table.standard_price, 1050.52, precision_digits=2),
            0,
    ...
    def test_02_compute_byproduct_price(self):
        ...
        self.assertEqual(
            scrap_wood.standard_price, 30, "Initial price of the By-Product should be 30"
        )
        self.dining_table.button_bom_cost()
        self.assertEqual(
            self.dining_table.standard_price,
        ...
        self.assertEqual(
            scrap_wood.standard_price, 20.63, "After computing price from BoM price should be 20.63"
        )
