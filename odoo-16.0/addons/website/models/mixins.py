...
class SeoMetadata(models.AbstractModel):
    ...
    def _default_website_meta(self):
        ...
        return {"default_opengraph": default_opengraph, "default_twitter": default_twitter}
...
class WebsiteCoverPropertiesMixin(models.AbstractModel):
    ...
    cover_properties = fields.Text(
        "Cover Properties", default=lambda s: json_safe.dumps(s._default_cover_properties())
    )
...
class WebsitePublishedMixin(models.AbstractModel):
    ...
    is_published = fields.Boolean(
        "Is Published", copy=False, default=lambda self: self._default_is_published(), index=True
    )
