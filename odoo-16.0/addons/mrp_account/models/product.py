...
class ProductProduct(models.Model):
    ...
    def _compute_average_price(self, qty_invoiced, qty_to_invoice, stock_moves, is_returned=False):
        ...
        for bom_line, moves_list in groupby(
            stock_moves.filtered(lambda sm: sm.state != "cancel"), lambda sm: sm.bom_line_id
        ):
            ...
            value += line_qty * bom_line.product_id._compute_average_price(
                qty_invoiced * line_qty, qty_to_invoice * line_qty, moves, is_returned=is_returned
            )
        return value
    ...
    def _compute_bom_price(self, bom, boms_to_recompute=False, byproduct_bom=False):
        ...
        for line in bom.bom_line_ids:
            ...
            if line.child_bom_id and line.child_bom_id in boms_to_recompute:
                ...
                total += (
                    line.product_id.uom_id._compute_price(child_total, line.product_uom_id)
                    * line.product_qty
                )
            else:
                total += (
