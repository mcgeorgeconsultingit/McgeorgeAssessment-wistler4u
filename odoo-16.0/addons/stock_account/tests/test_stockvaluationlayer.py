...
class TestStockValuationCommon(TransactionCase):
    ...
    def _make_in_move(
        self, product, quantity, unit_cost=None, create_picking=False, loc_dest=None, pick_type=None
    ):
...
class TestStockValuationStandard(TestStockValuationCommon):
    ...
    def test_currency_precision_and_standard_svl_value(self):
        ...
        try:
            ...
            self._make_in_move(
                product, 0.5, loc_dest=warehouse.lot_stock_id, pick_type=warehouse.in_type_id
            )
            self._make_out_move(
                product, 0.5, loc_src=warehouse.lot_stock_id, pick_type=warehouse.out_type_id
            )
