...
class ProjectMilestone(models.Model):
    ...
    project_id = fields.Many2one(
        "project.project", required=True, default=_get_default_project_id, ondelete="cascade"
    )
    ...
    task_count = fields.Integer(
        "# of Tasks", compute="_compute_task_count", groups="project.group_project_milestone"
    )
    can_be_marked_as_done = fields.Boolean(
        compute="_compute_can_be_marked_as_done", groups="project.group_project_milestone"
    )
