...
class ResConfigSettings(models.TransientModel):
    ...
    predictive_lead_scoring_start_date_str = fields.Char(
        string="Lead Scoring Starting Date in String", config_parameter="crm.pls_start_date"
    )
    ...
    predictive_lead_scoring_fields_str = fields.Char(
        string="Lead Scoring Frequency Fields in String", config_parameter="crm.pls_fields"
    )
