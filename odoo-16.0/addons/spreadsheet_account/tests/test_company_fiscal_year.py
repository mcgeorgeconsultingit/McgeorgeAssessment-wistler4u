...
class SpreadsheetFiscalYearTest(TransactionCase):
    def test_fiscal_year_reference(self):
        ...
        self.assertEqual(
            self.env["res.company"].get_fiscal_dates([{"company_id": None, "date": "2020-03-05"}]),
            [
    ...
    def test_fiscal_year_reference_last_day(self):
        ...
        self.assertEqual(
            self.env["res.company"].get_fiscal_dates([{"company_id": None, "date": "2020-02-03"}]),
            [
    ...
    def test_fiscal_year_reference_first_day(self):
        ...
        self.assertEqual(
            self.env["res.company"].get_fiscal_dates([{"company_id": None, "date": "2020-02-04"}]),
            [{"start": date(2020, 2, 4), "end": date(2021, 2, 3)}],
        )
    ...
    def test_result_order(self):
        ...
        [o1_request1, o1_request2] = self.env["res.company"].get_fiscal_dates([request1, request2])
        [o2_request2, o2_request1] = self.env["res.company"].get_fiscal_dates([request2, request1])
