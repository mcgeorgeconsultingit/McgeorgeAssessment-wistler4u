...
class TestPurchaseDashboard(AccountTestInvoicingCommon, MailCase):
    ...
    def test_purchase_dashboard(self):
        ...
        self.assertListEqual(
            [dashboard_result[key] for key in zero_value_keys], [0] * len(zero_value_keys)
        )
        ...
        self.assertEqual(
            ...
            format_amount(
                self.env, self.tax_purchase_a.compute_all(700.0)["total_included"], currency_id
            ),
        )
        ...
        self.assertEqual(
            ...
            format_amount(
                self.env, self.tax_purchase_a.compute_all(2100.0)["total_included"], currency_id
            ),
        )
