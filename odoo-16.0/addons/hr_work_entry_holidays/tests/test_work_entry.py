...
class TestWorkeEntryHolidaysWorkEntry(TestWorkEntryHolidaysBase):
    ...
    def test_refuse_leave_work_entry(self):
        ...
        self.assertEqual(
            work_entry.state, "conflict", "It should have an error (conflicting leave to approve"
        )
        leave.action_refuse()
    ...
    def test_time_week_leave_work_entry(self):
        ...
        self.assertEqual(
            sum_hours, 5.0, "It should equal the number of hours richard should have worked"
        )
