...
class TestPhonenumbersPatch(BaseCase):
    def test_region_CI_monkey_patch(self):
        ...
        if (
            ...
            self.assertEqual(
                parsed_phonenumber_1.country_code, 225, "The country code of Ivory Coast is 225"
            )
            ...
            self.assertEqual(
                parsed_phonenumber_2.country_code, 225, "The country code of Ivory Coast is 225"
            )
        else:
            self.assertFalse(
