...
class ProjectProductEmployeeMap(models.Model):
    ...
    cost_currency_id = fields.Many2one(
        "res.currency", string="Cost Currency", related="employee_id.currency_id", readonly=True
    )
    ...
    def _compute_is_cost_changed(self):
        for map_entry in self:
            map_entry.is_cost_changed = (
                map_entry.employee_id and map_entry.cost != map_entry.employee_id.hourly_cost
            )
