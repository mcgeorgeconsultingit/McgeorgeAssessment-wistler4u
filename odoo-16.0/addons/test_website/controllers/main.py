...
class WebsiteTest(Home):
    ...
    @http.route(
        "/ignore_args/converter/<string:a>", type="http", auth="public", website=True, sitemap=False
    )
    ...
    @http.route(
        "/test_validation_error_http", type="http", auth="public", website=True, sitemap=False
    )
    def test_validation_error_http(self, **kwargs):
        raise ValidationError("This is a validation http test")

    @http.route(
        "/test_validation_error_json", type="json", auth="public", website=True, sitemap=False
    )
    ...
    @http.route(
        "/test_internal_error_json", type="json", auth="public", website=True, sitemap=False
    )
    def test_internal_error_json(self, **kwargs):
        raise werkzeug.exceptions.InternalServerError()

    @http.route(
        "/test_internal_error_http", type="http", auth="public", website=True, sitemap=False
    )
    ...
    @http.route(
        ["/post"], type="http", auth="public", methods=["POST"], website=True, sitemap=False
    )
