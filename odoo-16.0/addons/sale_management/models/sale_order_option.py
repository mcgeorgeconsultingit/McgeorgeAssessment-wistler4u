...
class SaleOrderOption(models.Model):
    ...
    line_id = fields.Many2one(comodel_name="sale.order.line", ondelete="set null", copy=False)
    ...
    def _compute_is_present(self):
        ...
        for option in self:
            option.is_present = bool(
                option.order_id.order_line.filtered(lambda l: l.product_id == option.product_id)
            )
