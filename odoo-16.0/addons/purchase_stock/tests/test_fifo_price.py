...
class TestFifoPrice(ValuationReconciliationTestCommon):
    def test_00_test_fifo(self):
        ...
        self.assertEqual(
            product_cable_management_box.value_svl, 2900.0, "Stock valuation should be 2900"
        )
        ...
        self.assertEqual(
            product_cable_management_box.value_svl, 1600.0, "Stock valuation should be 1600"
        )
        ...
        self.assertEqual(
            product_cable_management_box.value_svl, 1560.0, "Stock valuation should be 1560"
        )
        self.assertEqual(
            product_cable_management_box.qty_available, 19.5, "Should still have 19.5 in stock"
        )
        ...
        self.assertEqual(
            original_out_move.product_id.value_svl, 12000.0, "Value of the move should be 12000"
        )
        self.assertEqual(
            original_out_move.product_id.qty_available, 150.0, "Qty available should be 150"
        )
