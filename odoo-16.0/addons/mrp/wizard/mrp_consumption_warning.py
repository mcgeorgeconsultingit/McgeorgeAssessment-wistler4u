...
class MrpConsumptionWarningLine(models.TransientModel):
    ...
    mrp_consumption_warning_id = fields.Many2one(
        "mrp.consumption.warning", "Parent Wizard", readonly=True, required=True, ondelete="cascade"
    )
    mrp_production_id = fields.Many2one(
        "mrp.production", "Manufacturing Order", readonly=True, required=True, ondelete="cascade"
    )
