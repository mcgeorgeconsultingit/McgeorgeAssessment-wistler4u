...
class TestPoSOtherCurrencyConfig(TestPoSCommon):
    ...
    def setUp(self):
        ...
        self.config.pricelist_id.write(
            {"item_ids": [(6, 0, (self.config.pricelist_id.item_ids | pricelist_item).ids)]}
        )
        ...
        self._run_test(
            {
                ...
                "orders": [
                    ...
                    {
                        "pos_order_lines_ui_args": [(self.product1, 5), (self.product2, 5)],
                        "uid": "00100-010-0002",
                    },
                    {
        ...
        self._run_test(
            {
                ...
                "orders": [
                    {
                        "pos_order_lines_ui_args": [(self.product4, 7), (self.product5, 7)],
                        "uid": "00100-010-0001",
                    },
                    {
                        "pos_order_lines_ui_args": [
                    ...
                    {
                        "pos_order_lines_ui_args": [(self.product5, 2), (self.product6, 13)],
                        "uid": "00100-010-0003",
                    },
