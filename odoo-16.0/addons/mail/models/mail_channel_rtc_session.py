...
class MailRtcSession(models.Model):
    ...
    channel_id = fields.Many2one(
        "mail.channel", related="channel_member_id.channel_id", store=True, readonly=True
    )
    ...
    def unlink(self):
            ...
            (
                ...
                "mail.channel/rtc_sessions_update",
                {
                    ...
                    "rtcSessions": [
                        (
                            "insert-and-unlink",
                            [{"id": session_data["id"]} for session_data in sessions_data],
                        )
                    ],
                },
            )
        ...
        for rtc_session in self:
            ...
            notifications.append(
                (target, "mail.channel.rtc.session/ended", {"sessionId": rtc_session.id})
            )
