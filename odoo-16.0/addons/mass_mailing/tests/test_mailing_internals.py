...
class TestMassMailValues(MassMailCommon):
    ...
    def test_mailing_computed_fields(self):
        ...
        self.assertEqual(
            literal_eval(mailing.mailing_domain), [("email", "ilike", "test.example.com")]
        )
    ...
    def test_mailing_computed_fields_default(self):
        mailing = (
            ...
            .with_context(default_mailing_domain=repr([("email", "ilike", "test.example.com")]))
            .create(
                {
                    "name": "TestMailing",
                    "subject": "Test",
...
class TestMailingScheduleDateWizard(MassMailCommon):
    ...
    def test_mailing_schedule_date(self):
        mailing = self.env["mailing.mailing"].create({"name": "mailing", "subject": "some subject"})
