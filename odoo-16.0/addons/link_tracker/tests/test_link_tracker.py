...
class TestLinkTracker(common.TransactionCase, MockLinkTracker):
    ...
    def test_no_external_tracking(self):
        ...
        self.assertLinkParams(
            f"{self._web_base_url}/test", link, {**expected_utm_params, "a": "example.com"}
        )
        ...
        self.assertLinkParams("/test", link, {**expected_utm_params, "a": "example.com"})
        ...
        self.assertLinkParams(
            "http://external.com/test", link, {**expected_utm_params, "a": "example.com"}
        )
