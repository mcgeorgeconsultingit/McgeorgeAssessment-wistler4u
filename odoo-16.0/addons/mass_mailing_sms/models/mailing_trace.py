...
class MailingTrace(models.Model):
    ...
    trace_type = fields.Selection(selection_add=[("sms", "SMS")], ondelete={"sms": "set default"})
    ...
    def _get_random_code(self):
        ...
        return "".join(
            random.choice(string.ascii_letters + string.digits) for dummy in range(self.CODE_SIZE)
        )
