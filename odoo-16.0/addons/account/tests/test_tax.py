        ...
        cls.group_tax = cls.env["account.tax"].create(
            {
                ...
                "amount": 0,
                "sequence": 5,
                "children_tax_ids": [(4, cls.fixed_tax.id, 0), (4, cls.percent_tax.id, 0)],
            }
        )
        ...
        cls.group_tax_percent = cls.env["account.tax"].create(
            {
                ...
                "amount": 0,
                "sequence": 6,
                "children_tax_ids": [(4, cls.percent_tax.id, 0), (4, cls.percent_tax_bis.id, 0)],
            }
        )
        cls.group_of_group_tax = cls.env["account.tax"].create(
            {
                ...
                "amount": 0,
                "sequence": 7,
                "children_tax_ids": [(4, cls.group_tax.id, 0), (4, cls.group_tax_bis.id, 0)],
            }
        )
