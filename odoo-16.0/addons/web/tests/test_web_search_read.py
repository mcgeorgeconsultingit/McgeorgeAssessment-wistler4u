...
class TestWebSearchRead(common.TransactionCase):
    ...
    def assert_web_search_read(
        self, expected_length, expected_records_length, expected_search_count_called=True, **kwargs
    ):
    ...
    def test_web_search_read(self):
        ...
        self.assert_web_search_read(
            12, 2, limit=2, offset=10, count_limit=12, expected_search_count_called=False
        )
