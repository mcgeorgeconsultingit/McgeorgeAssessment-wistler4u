...
class Event(models.Model):
    ...
    def _compute_sale_price_subtotal(self):
        ...
        if self.ids:
            ...
            company_by_event = {event._origin.id or event.id: event.company_id for event in self}

            currency_by_event = {event._origin.id or event.id: event.currency_id for event in self}
