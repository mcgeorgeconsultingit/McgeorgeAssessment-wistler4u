   ...
   font-size: 30px; max-width: 100%; after: "Not sure
    ...
    def test_quote_basic_text(self):
        test_data = [
            ...
            ("""<p>This is Sparta!\n--\nAdministrator</p>""", [], ["\n--\nAdministrator"]),
            ("""<p>This is Sparta!<br/>--<br>Administrator</p>""", ["This is Sparta!"], []),
            (
                """This is Sparta!\n>Ah bon ?\nCertes\n> Chouette !\nClair""",
        ...
        for test, in_lst, out_lst in test_data:
            ...
            for text in out_lst:
                self.assertIn(
                    '<span data-o-mail-quote="1">%s</span>' % misc.html_escape(text), new_html
                )
    ...
    def test_cid_with_at(self):
        ...
        self.assertEqual(
            img_tag, sanitized, "img with can have cid containing @ and shouldn't be escaped"
        )
...
class TestHtmlTools(BaseCase):
    ...
    def test_append_to_html(self):
        ...
        for html, content, plaintext_flag, preserve_flag, container_tag, expected in test_samples:
            self.assertEqual(
                append_content_to_html(html, content, plaintext_flag, preserve_flag, container_tag),
                expected,
...
class TestEmailTools(BaseCase):
    ...
    def test_email_domain_normalize(self):
        self.assertEqual(
            email_domain_normalize("Test.Com"), "test.com", "Should have normalized the domain"
        )
        self.assertEqual(
...
class _FakeSMTP:
    ...
    def sendmail(self, smtp_from, smtp_to_list, message_str, mail_options=(), rcpt_options=()):
