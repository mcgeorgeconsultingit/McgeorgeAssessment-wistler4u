...
class TestMailComposerForm(TestMailComposer):
    ...
    def test_composer_default_recipients(self):
        ...
        form.body = "<p>Hello</p>"
        self.assertEqual(
            form.partner_ids._get_ids(), partner_classic.ids, "Default populates the field"
        )
        saved_form = form.save()
        self.assertEqual(saved_form.partner_ids, partner_classic, "Default value is kept at save")
    ...
    def test_composer_template_recipients_private(self):
        ...
        new_partner = self.env["res.partner"].search([("email_normalized", "=", email_to_new)])
        ...
        self.assertEqual(
            message.partner_ids, partner_classic + new_partner, "FIXME: loosing private partner"
        )
