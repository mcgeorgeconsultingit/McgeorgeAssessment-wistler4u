...
class WebsiteEventBoothController(WebsiteEventController):
    def _prepare_booth_registration_values(self, event, kwargs):
        booth_values = super(WebsiteEventBoothController, self)._prepare_booth_registration_values(
            event, kwargs
        )
    ...
    def _prepare_booth_registration_partner_values(self, event, kwargs):
        ...
        return super(WebsiteEventBoothController, self)._prepare_booth_registration_partner_values(
            event, kwargs
        )
    ...
    def _prepare_booth_registration_sponsor_values(self, event, booth_values, kwargs):
        sponsor_values = {
            ...
            "sponsor_website_description": plaintext2html(kwargs.get("sponsor_description"))
