...
def ctx_tz(record, field):
    ...
    if res_lang:
        ...
        return datetime.strftime(
            timestamp.astimezone(tz_name), res_lang.date_format + " " + res_lang.time_format
        )
...
class ResCompany(models.Model):
    ...
    def _action_check_pos_hash_integrity(self):
        return self.env.ref("l10n_fr_pos_cert.action_report_pos_hash_integrity").report_action(
            self.id
        )
